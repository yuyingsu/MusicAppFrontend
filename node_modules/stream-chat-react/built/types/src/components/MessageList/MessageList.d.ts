...
declare type PropsDrilledToMessage = 'additionalMessageInputProps' | 'Attachment' | 'Avatar' | 'Message' | 'getFlagMessageErrorNotification' | 'getFlagMessageErrorNotification' | 'getFlagMessageSuccessNotification' | 'getMuteUserErrorNotification' | 'getMuteUserSuccessNotification' | 'getPinMessageErrorNotification' | 'messageActions' | 'mutes' | 'onMentionsClick' | 'onMentionsHover' | 'onUserClick' | 'onUserHover' | 'pinPermissions' | 'unsafeHTML';
declare type PropsDrilledToMessageListInner = 'DateSeparator' | 'disableDateSeparator' | 'EmptyStateIndicator' | 'HeaderComponent' | 'headerPosition' | 'hideDeletedMessages' | 'hideNewMessageSeparator' | 'internalInfiniteScrollProps' | 'messages' | 'MessageSystem' | 'noGroupByUser' | 'read' | 'threadList' | 'TypingIndicator';
