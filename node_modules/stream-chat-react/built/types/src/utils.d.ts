...
export declare const truncate: (input?: string | undefined, length?: number | undefined, end?: string) => string;
...
export declare const smartRender: (ElementOrComponentOrLiteral: React.ComponentType, props?: Record<string, unknown> | undefined, fallback?: React.ComponentClass<{}, any> | React.FunctionComponent<{}> | null | undefined) => JSX.Element;
