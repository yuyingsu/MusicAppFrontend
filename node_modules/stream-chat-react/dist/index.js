...
var DefaultEmoji = require('emoji-mart/dist/components/emoji/nimble-emoji.js');
var DefaultEmojiIndex = require('emoji-mart/dist/utils/emoji-index/nimble-emoji-index.js');
var DefaultEmojiPicker = require('emoji-mart/dist/components/picker/nimble-picker.js');
...
var DefaultEmojiPicker__default = /*#__PURE__*/_interopDefaultLegacy(DefaultEmojiPicker);
...
var TranslationContext = React__default['default'].createContext({
    ...
    tDateTimeParser: function (input) { return Dayjs__default['default'](input); },
    userLanguage: 'en',
});
...
var UnMemoizedCard = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__message-attachment-card str-chat__message-attachment-card--" + type },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__message-attachment-card--content' },
            ...
            type === 'giphy' && (React__default['default'].createElement("img", { alt: 'giphy logo', className: 'str-chat__message-attachment-card__giphy-logo', "data-testid": 'card-giphy', src: giphyLogo })))));
};
/**
...
var UnMemoizedFileAttachment = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__message-attachment-file--item', "data-testid": 'attachment-file' },
        React__default['default'].createElement(reactFileUtils.FileIcon, { big: true, filename: attachment.title, mimeType: attachment.mime_type, size: 30 }),
        React__default['default'].createElement("div", { className: 'str-chat__message-attachment-file--item-text' },
            ...
            attachment.file_size && Number.isFinite(Number(attachment.file_size)) && (React__default['default'].createElement("span", null, prettybytes__default['default'](attachment.file_size))))));
};
...
var isGalleryAttachment = function (attachment) { return attachment.type === 'gallery'; };
...
var renderAttachmentWithinContainer = function (props) {
    ...
    var extra = componentType === 'card' && !(attachment === null || attachment === void 0 ? void 0 : attachment.image_url) && !(attachment === null || attachment === void 0 ? void 0 : attachment.thumb_url)
        ? 'no-image'
        : attachment && attachment.actions && attachment.actions.length
            ? 'actions'
            : '';
    return (React__default['default'].createElement("div", { className: "str-chat__message-attachment str-chat__message-attachment--" + componentType + " str-chat__message-attachment--" + ((attachment === null || attachment === void 0 ? void 0 : attachment.type) || '') + " str-chat__message-attachment--" + componentType + "--" + extra, key: (attachment === null || attachment === void 0 ? void 0 : attachment.id) + "-" + ((attachment === null || attachment === void 0 ? void 0 : attachment.type) || 'none') + " " }, children));
};
var renderAttachmentActions = function (props) {
    var actionHandler = props.actionHandler, attachment = props.attachment, AttachmentActions = props.AttachmentActions;
    if (!AttachmentActions || !attachment.actions || !attachment.actions.length) {
        return null;
    }
    return (React__default['default'].createElement(AttachmentActions, __assign({}, attachment, { actionHandler: function (event, name, value) { return actionHandler === null || actionHandler === void 0 ? void 0 : actionHandler(name, value, event); }, actions: attachment.actions || [], id: attachment.id || '', key: "key-actions-" + attachment.id, text: attachment.text || '' })));
};
var renderGallery = function (props) {
    var attachment = props.attachment, Gallery = props.Gallery;
    if (!Gallery)
        return null;
    return renderAttachmentWithinContainer({
        attachment: attachment,
        children: React__default['default'].createElement(Gallery, { images: attachment.images || [], key: 'gallery' }),
        componentType: 'gallery',
    });
};
var renderImage = function (props) {
    var attachment = props.attachment, Image = props.Image;
    if (!Image)
        return null;
...
var renderCard = function (props) {
    var attachment = props.attachment, Card = props.Card;
    if (!Card)
        return null;
    if (attachment.actions && attachment.actions.length) {
        return renderAttachmentWithinContainer({
            attachment: attachment,
            children: (React__default['default'].createElement("div", { className: 'str-chat__attachment', key: "key-image-" + attachment.id },
                React__default['default'].createElement(Card, __assign({}, attachment, { key: "key-card-" + attachment.id })),
                renderAttachmentActions(props))),
            componentType: 'card',
        });
    }
    return renderAttachmentWithinContainer({
        attachment: attachment,
        children: React__default['default'].createElement(Card, __assign({}, attachment, { key: "key-card-" + attachment.id })),
        componentType: 'card',
    });
};
var renderFile = function (props) {
    var attachment = props.attachment, File = props.File;
    if (!File || !attachment.asset_url)
        return null;
    return renderAttachmentWithinContainer({
        attachment: attachment,
...
var renderAudio = function (props) {
    var attachment = props.attachment, Audio = props.Audio;
    if (!Audio)
        return null;
    return renderAttachmentWithinContainer({
        attachment: attachment,
        children: (React__default['default'].createElement("div", { className: 'str-chat__attachment', key: "key-video-" + attachment.id },
            React__default['default'].createElement(Audio, { og: attachment }))),
        componentType: 'audio',
    });
};
var renderMedia = function (props) {
    var attachment = props.attachment, Media = props.Media;
    if (!Media)
        return null;
    if (attachment.actions && attachment.actions.length) {
        return renderAttachmentWithinContainer({
...
var Attachment = function (props) {
    var _a;
    var _b = props.AttachmentActions, AttachmentActions$1 = _b === void 0 ? AttachmentActions : _b, attachments = props.attachments, _c = props.Audio, Audio$1 = _c === void 0 ? Audio : _c, _d = props.Card, Card$1 = _d === void 0 ? Card : _d, _e = props.File, File = _e === void 0 ? FileAttachment : _e, _f = props.Gallery, Gallery$1 = _f === void 0 ? Gallery : _f, _g = props.Image, Image = _g === void 0 ? ImageComponent : _g, _h = props.Media, Media = _h === void 0 ? ReactPlayer__default['default'] : _h, rest = __rest(props, ["AttachmentActions", "attachments", "Audio", "Card", "File", "Gallery", "Image", "Media"]);
    var gallery = {
    ...
    var propsWithDefault = __assign({ AttachmentActions: AttachmentActions$1,
        Audio: Audio$1,
        Card: Card$1,
        File: File,
        Gallery: Gallery$1,
        Image: Image,
        Media: Media }, rest);
    return (React__default['default'].createElement(React__default['default'].Fragment, null, newAttachments === null || newAttachments === void 0 ? void 0 : newAttachments.map(function (attachment) {
        if (isGalleryAttachment(attachment)) {
            return renderGallery(__assign(__assign({}, propsWithDefault), { attachment: attachment }));
        }
        if (isImageAttachment(attachment)) {
            return renderImage(__assign(__assign({}, propsWithDefault), { attachment: attachment }));
        }
        if (isFileAttachment(attachment)) {
            return renderFile(__assign(__assign({}, propsWithDefault), { attachment: attachment }));
        }
        if (isAudioAttachment(attachment)) {
            return renderAudio(__assign(__assign({}, propsWithDefault), { attachment: attachment }));
        }
        if (isMediaAttachment(attachment)) {
            return renderMedia(__assign(__assign({}, propsWithDefault), { attachment: attachment }));
        }
        return renderCard(__assign(__assign({}, propsWithDefault), { attachment: attachment }));
    })));
};
...
var truncate = function (input, length, end) {
    if (end === void 0) { end = '...'; }
    if (!input || !length)
        return '';
...
var renderText = function (text, mentioned_users, options) {
    ...
    linkify__namespace.find(newText).forEach(function (_a) {
...
var Listener = function Listener() {
  ...
  _defineProperty__default['default'](this, "add", function (keyCodes, fn) {
    ...
    if (_typeof__default['default'](keyCode) !== 'object') keyCode = [keyCode];
...
var ReactTextareaAutocomplete = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass__default['default'](ReactTextareaAutocomplete, [{
    ...
    value: function render() {
      ...
      }, this.renderSuggestionListContainer(), /*#__PURE__*/React__default['default'].createElement(Textarea__default['default'], _extends__default['default']({}, this._cleanUpProps(), {
...
var channelReducer = function (state, action) {
    ...
    switch (action.type) {
        case 'initStateFromChannel': {
            ...
            return __assign(__assign({}, state), { loading: false, members: __assign({}, channel.state.members), messages: __spreadArrays(channel.state.messages), pinnedMessages: __spreadArrays(channel.state.pinnedMessages), read: __assign({}, channel.state.read), watcherCount: channel.state.watcher_count, watchers: __assign({}, channel.state.watchers) });
        }
        case 'copyStateFromChannelOnEvent': {
            var channel = action.channel;
            return __assign(__assign({}, state), { members: __assign({}, channel.state.members), messages: __spreadArrays(channel.state.messages), pinnedMessages: __spreadArrays(channel.state.pinnedMessages), read: __assign({}, channel.state.read), typing: __assign({}, channel.state.typing), watcherCount: channel.state.watcher_count, watchers: __assign({}, channel.state.watchers) });
        }
        case 'setThread': {
        ...
        case 'copyMessagesFromChannel': {
            ...
            return __assign(__assign({}, state), { messages: __spreadArrays(channel.state.messages), pinnedMessages: __spreadArrays(channel.state.pinnedMessages), threadMessages: parentId
...
var LoadingItems = function () { return (React__default['default'].createElement("div", { className: 'str-chat__loading-channels-item' },
...
var ChannelContext = React__default['default'].createContext({});
var ChannelProvider = function (_a) {
    var children = _a.children, value = _a.value;
    return (React__default['default'].createElement(ChannelContext.Provider, { value: value }, children));
};
 ...
 * wrapped component must be provided as the first generic.
 */
var withChannelContext = function (Component) {
    var WithChannelContextComponent = function (props) {
        var channelContext = useChannelContext();
        return React__default['default'].createElement(Component, __assign({}, props, channelContext));
    };
    WithChannelContextComponent.displayName = (Component.displayName ||
        Component.name ||
...
function useActionHandler(message) {
    var _this = this;
    var _a = useChannelContext(), channel = _a.channel, removeMessage = _a.removeMessage, updateMessage = _a.updateMessage;
...
var useBreakpoint = function () {
    ...
    React.useEffect(function () {
        var getInnerWidth = throttle__default['default'](function () { return setBreakpoint(getDeviceWidth(window.innerWidth)); }, 200);
...
var useDeleteHandler = function (message) {
    var _a = useChannelContext(), client = _a.client, updateMessage = _a.updateMessage;
...
var getMessageActions = function (actions, _a) {
    var canDelete = _a.canDelete, canEdit = _a.canEdit, canFlag = _a.canFlag, canMute = _a.canMute, canPin = _a.canPin, canReact = _a.canReact, canReply = _a.canReply;
...
var useMentionsHandler = function (message, customMentionHandler) {
    var _a = useChannelContext(), channelOnMentionsClick = _a.onMentionsClick, channelOnMentionsHover = _a.onMentionsHover;
    var onMentionsClick = (customMentionHandler === null || customMentionHandler === void 0 ? void 0 : customMentionHandler.onMentionsClick) || channelOnMentionsClick || (function () { return null; });
    var onMentionsHover = (customMentionHandler === null || customMentionHandler === void 0 ? void 0 : customMentionHandler.onMentionsHover) || channelOnMentionsHover || (function () { return null; });
    return {
        onMentionsClick: createEventHandler(onMentionsClick, message),
        onMentionsHover: createEventHandler(onMentionsHover, message),
    };
};
var useMentionsUIHandler = function (message, eventHandlers) {
    var _a = useChannelContext(), onMentionsClick = _a.onMentionsClick, onMentionsHover = _a.onMentionsHover;
    return {
...
var usePinHandler = function (message, permissions, notifications) {
    ...
    var _a = useChannelContext(), channel = _a.channel, client = _a.client;
    var t = useTranslationContext().t;
    var canPin = function () {
        var _a;
        ...
        if (currentChannelPermissions &&
            typeof ((_a = client.user) === null || _a === void 0 ? void 0 : _a.role) === 'string' &&
...
var useReactionHandler = function (message) {
    var _a = useChannelContext(), channel = _a.channel, updateMessage = _a.updateMessage;
    var client = useChatContext().client;
...
var useReactionClick = function (message, reactionSelectorRef, messageWrapperRef) {
    var _a, _b;
...
var useRetryHandler = function (customRetrySendMessage) {
    ...
    return function (message) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(retrySendMessage && message)) return [3 /*break*/, 2];
...
var useUserRole = function (message) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    var _l = useChannelContext(), channel = _l.channel, client = _l.client; // TODO - fix breaking tests that result from pulling client from ChatContext
    ...
    var isModerator = ((_f = client === null || client === void 0 ? void 0 : client.user) === null || _f === void 0 ? void 0 : _f.role) === 'channel_moderator' ||
        ((_h = (_g = channel === null || channel === void 0 ? void 0 : channel.state) === null || _g === void 0 ? void 0 : _g.membership) === null || _h === void 0 ? void 0 : _h.role) === 'channel_moderator' ||
        ((_k = (_j = channel === null || channel === void 0 ? void 0 : channel.state) === null || _j === void 0 ? void 0 : _j.membership) === null || _k === void 0 ? void 0 : _k.role) === 'moderator';
...
var UnMemoizedMessageTimestamp = function (props) {
    var _a = props.calendar, calendar = _a === void 0 ? false : _a, _b = props.customClass, customClass = _b === void 0 ? '' : _b, _c = props.format, format = _c === void 0 ? defaultTimestampFormat : _c, formatDate = props.formatDate, message = props.message;
    ...
    if (!when)
        return null;
    return (React__default['default'].createElement("time", { className: customClass, dateTime: createdAt, title: createdAt }, when));
};
...
var UnMemoizedMessageActionsBox = function (props) {
    var getMessageActions = props.getMessageActions, handleDelete = props.handleDelete, handleEdit = props.handleEdit, handleFlag = props.handleFlag, handleMute = props.handleMute, handlePin = props.handlePin, isUserMuted = props.isUserMuted, message = props.message, messageListRect = props.messageListRect, mine = props.mine, _a = props.open, open = _a === void 0 ? false : _a;
    var t = useTranslationContext().t;
    var _b = React.useState(false), reverse = _b[0], setReverse = _b[1];
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__message-actions-box\n        " + (open ? 'str-chat__message-actions-box--open' : '') + "\n        " + (mine ? 'str-chat__message-actions-box--mine' : '') + "\n        " + (reverse ? 'str-chat__message-actions-box--reverse' : '') + "\n      ", "data-testid": 'message-actions-box', ref: checkIfReverse },
        React__default['default'].createElement("ul", { className: 'str-chat__message-actions-list' },
            messageActions.indexOf(MESSAGE_ACTIONS.pin) > -1 && !(message === null || message === void 0 ? void 0 : message.parent_id) && (React__default['default'].createElement("button", { onClick: handlePin },
                React__default['default'].createElement("li", { className: 'str-chat__message-actions-list-item' }, !(message === null || message === void 0 ? void 0 : message.pinned) ? t('Pin') : t('Unpin')))),
            ...
            messageActions.indexOf(MESSAGE_ACTIONS.mute) > -1 && (React__default['default'].createElement("button", { onClick: handleMute },
                React__default['default'].createElement("li", { className: 'str-chat__message-actions-list-item' }, isUserMuted && isUserMuted() ? t('Unmute') : t('Mute')))),
...
var MessageActions = function (props) {
    var addNotification = props.addNotification, customWrapperClass = props.customWrapperClass, getMessageActions = props.getMessageActions, getFlagMessageErrorNotification = props.getFlagMessageErrorNotification, getFlagMessageSuccessNotification = props.getFlagMessageSuccessNotification, getMuteUserErrorNotification = props.getMuteUserErrorNotification, getMuteUserSuccessNotification = props.getMuteUserSuccessNotification, getPinMessageErrorNotification = props.getPinMessageErrorNotification, propHandleDelete = props.handleDelete, propHandleFlag = props.handleFlag, propHandleMute = props.handleMute, propHandlePin = props.handlePin, inline = props.inline, message = props.message, messageListRect = props.messageListRect, messageWrapperRef = props.messageWrapperRef, _a = props.pinPermissions, pinPermissions = _a === void 0 ? defaultPinPermissions : _a, setEditingState = props.setEditingState;
    var mutes = useChatContext().mutes;
    var _b = React.useState(false), actionsBoxOpen = _b[0], setActionsBoxOpen = _b[1];
    ...
    return (React__default['default'].createElement(MessageActionsWrapper, { customWrapperClass: customWrapperClass, inline: inline, setActionsBoxOpen: setActionsBoxOpen },
        React__default['default'].createElement(MessageActionsBox, { getMessageActions: getMessageActions, handleDelete: propHandleDelete || handleDelete, handleEdit: setEditingState, handleFlag: propHandleFlag || handleFlag, handleMute: propHandleMute || handleMute, handlePin: propHandlePin || handlePin, isUserMuted: isMuted, message: message, messageListRect: messageListRect, mine: isMyMessage, open: actionsBoxOpen }),
...
var MML = function (props) {
    ...
    if (!source)
        return null;
    return (React__default['default'].createElement(mmlReact.MML, { className: "mml-align-" + align, Loading: null, onSubmit: actionHandler, source: source, Success: null, theme: (theme || '').replace(' ', '-') }));
};
...
var UnMemoizedFixedHeightMessage = function (props) {
    ...
    var groupedByUser = props.groupedByUser, message = props.message;
    var theme = useChatContext().theme;
    ...
    var messageActionsHandler = React.useCallback(function () { return getMessageActions(['delete'], { canDelete: role.canDeleteMessage }); }, [role]);
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__virtual-message__wrapper " + (role.isMyMessage ? 'str-chat__virtual-message__wrapper--me' : '') + " " + (groupedByUser ? 'str-chat__virtual-message__wrapper--group' : ''), key: message.id },
        React__default['default'].createElement(Avatar, { image: (_d = message.user) === null || _d === void 0 ? void 0 : _d.image, name: ((_e = message.user) === null || _e === void 0 ? void 0 : _e.name) || ((_f = message.user) === null || _f === void 0 ? void 0 : _f.id), shape: 'rounded', size: 38 }),
        React__default['default'].createElement("div", { className: 'str-chat__virtual-message__content' },
            React__default['default'].createElement("div", { className: 'str-chat__virtual-message__meta' },
                React__default['default'].createElement("div", { className: 'str-chat__virtual-message__author', style: { color: userColor } },
                    React__default['default'].createElement("strong", null, ((_g = message.user) === null || _g === void 0 ? void 0 : _g.name) || 'unknown'))),
            ...
            React__default['default'].createElement("div", { className: 'str-chat__virtual-message__text', "data-testid": 'msg-text' },
                ...
                React__default['default'].createElement("div", { className: 'str-chat__virtual-message__data' },
                    React__default['default'].createElement(MessageActions, { customWrapperClass: 'str-chat__virtual-message__actions', getMessageActions: messageActionsHandler, message: message }),
...
var UnMemoizedMessageOptions = function (props) {
    var _a;
    var _b = props.displayActions, displayActions = _b === void 0 ? true : _b, _c = props.displayLeft, displayLeft = _c === void 0 ? true : _c, _d = props.displayReplies, displayReplies = _d === void 0 ? true : _d, getMessageActions = props.getMessageActions, propHandleOpenThread = props.handleOpenThread, initialMessage = props.initialMessage, message = props.message, messageWrapperRef = props.messageWrapperRef, onReactionListClick = props.onReactionListClick, _e = props.theme, theme = _e === void 0 ? 'simple' : _e, threadList = props.threadList;
    var channel = useChannelContext().channel;
    ...
    var shouldShowReplies = messageActions.indexOf(MESSAGE_ACTIONS.reply) > -1 &&
        displayReplies &&
        !threadList &&
        channelConfig &&
    ...
    if (isMyMessage && displayLeft) {
        return (React__default['default'].createElement("div", { className: "str-chat__message-" + theme + "__actions", "data-testid": 'message-options-left' },
            displayActions && React__default['default'].createElement(MessageActions, __assign({}, props, { messageWrapperRef: messageWrapperRef })),
            shouldShowReplies && (React__default['default'].createElement("div", { className: "str-chat__message-" + theme + "__actions__action str-chat__message-" + theme + "__actions__action--thread", "data-testid": 'thread-action', onClick: propHandleOpenThread || handleOpenThread },
...
var UnMemoizedReactionSelector = React__default['default'].forwardRef(function (props, ref) {
    var _a;
    var _b = props.Avatar, Avatar$1 = _b === void 0 ? Avatar : _b, _c = props.detailedView, detailedView = _c === void 0 ? true : _c, handleReaction = props.handleReaction, latest_reactions = props.latest_reactions, reaction_counts = props.reaction_counts, reactionOptionsProp = props.reactionOptions, _d = props.reverse, reverse = _d === void 0 ? false : _d;
    var emojiConfig = useChannelContext().emojiConfig;
    var _e = emojiConfig || {}, defaultMinimalEmojis = _e.defaultMinimalEmojis, Emoji = _e.Emoji, fullEmojiData = _e.emojiData, emojiSetDef = _e.emojiSetDef;
    ...
    var getUsersPerReactionType = function (type) { return latest_reactions === null || latest_reactions === void 0 ? void 0 : latest_reactions.map(function (reaction) {
        var _a, _b;
    ...
    var getLatestUserForReactionType = function (type) {
        var _a;
        return ((_a = latest_reactions === null || latest_reactions === void 0 ? void 0 : latest_reactions.find(function (reaction) { return reaction.type === type && !!reaction.user; })) === null || _a === void 0 ? void 0 : _a.user) ||
            undefined;
    };
    return (React__default['default'].createElement("div", { className: "str-chat__reaction-selector " + (reverse ? 'str-chat__reaction-selector--reverse' : ''), "data-testid": 'reaction-selector', ref: ref },
        ...
        React__default['default'].createElement("ul", { className: 'str-chat__message-reactions-list' }, reactionOptions === null || reactionOptions === void 0 ? void 0 : reactionOptions.map(function (reactionOption) {
            var latestUser = getLatestUserForReactionType(reactionOption.id);
            var count = reaction_counts && reaction_counts[reactionOption.id];
            return (React__default['default'].createElement("li", { className: 'str-chat__message-reactions-list-item', "data-text": reactionOption.id, key: "item-" + reactionOption.id, onClick: function (event) { return handleReaction && handleReaction(reactionOption.id, event); } },
                !!count && detailedView && (React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement("div", { className: 'latest-user', onClick: hideTooltip, onMouseEnter: function (e) { return showTooltip(e, reactionOption.id); }, onMouseLeave: hideTooltip }, latestUser ? (React__default['default'].createElement(Avatar$1, { image: latestUser.image, name: latestUser.name, size: 20 })) : (React__default['default'].createElement("div", { className: 'latest-user-not-found' }))))),
                Emoji && (React__default['default'].createElement(Emoji
                // @ts-expect-error
                , __assign({ 
                    // @ts-expect-error
                    emoji: reactionOption }, emojiSetDef, { 
                    // @ts-expect-error
                    data: emojiData }))),
...
var UnMemoizedReactionsList = function (props) {
    var onClick = props.onClick, reaction_counts = props.reaction_counts, reactionOptionsProp = props.reactionOptions, reactions = props.reactions, _a = props.reverse, reverse = _a === void 0 ? false : _a;
    var emojiConfig = useChannelContext().emojiConfig;
    var _b = emojiConfig || {}, defaultMinimalEmojis = _b.defaultMinimalEmojis, Emoji = _b.Emoji, fullEmojiData = _b.emojiData, emojiSetDef = _b.emojiSetDef;
    var emojiData = React.useMemo(function () { return getStrippedEmojiData(fullEmojiData); }, [fullEmojiData]);
    var reactionOptions = reactionOptionsProp || defaultMinimalEmojis || [];
    var getTotalReactionCount = function () {
        return Object.values(reaction_counts || {}).reduce(function (total, count) { return total + count; }, 0);
    };
    var getOptionForType = function (type) { return reactionOptions.find(function (option) { return option.id === type; }); };
    var getReactionTypes = function () {
        if (!reactions)
            return [];
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__reaction-list " + (reverse ? 'str-chat__reaction-list--reverse' : ''), "data-testid": 'reaction-list', onClick: onClick },
        React__default['default'].createElement("ul", null,
            getReactionTypes().map(function (reactionType) {
                var emojiDefinition = getOptionForType(reactionType);
                return emojiDefinition ? (React__default['default'].createElement("li", { key: emojiDefinition.id },
                    Emoji && (React__default['default'].createElement(Emoji
                    // @ts-expect-error
                    , __assign({ 
                        // @ts-expect-error
                        emoji: emojiDefinition }, emojiSetDef, { 
                        // @ts-expect-error
                        data: emojiData, size: 16 }))),
                    "\u00A0")) : null;
            }),
...
var UnMemoizedSimpleReactionsList = function (props) {
    var handleReaction = props.handleReaction, reaction_counts = props.reaction_counts, reactionOptionsProp = props.reactionOptions, reactions = props.reactions;
    var emojiConfig = useChannelContext().emojiConfig;
    var _a = emojiConfig || {}, defaultMinimalEmojis = _a.defaultMinimalEmojis, Emoji = _a.Emoji, defaultEmojiData = _a.emojiData, emojiSetDef = _a.emojiSetDef;
    ...
    var getUsersPerReactionType = function (type) { return reactions === null || reactions === void 0 ? void 0 : reactions.map(function (reaction) {
        var _a, _b;
        if (reaction.type === type) {
            return ((_a = reaction.user) === null || _a === void 0 ? void 0 : _a.name) || ((_b = reaction.user) === null || _b === void 0 ? void 0 : _b.id);
        }
    ...
    return (React__default['default'].createElement("ul", { className: 'str-chat__simple-reactions-list', "data-testid": 'simple-reaction-list', onMouseLeave: function () { return setTooltipReactionType(undefined); } },
        getReactionTypes().map(function (reactionType, i) {
            var _a, _b;
            var emojiDefinition = getOptionForType(reactionType);
            return emojiDefinition ? (React__default['default'].createElement("li", { className: 'str-chat__simple-reactions-list-item', key: (emojiDefinition === null || emojiDefinition === void 0 ? void 0 : emojiDefinition.id) + "-" + i, onClick: function (event) { return handleReaction(reactionType, event); } },
                React__default['default'].createElement("span", { onMouseEnter: function () { return setTooltipReactionType(reactionType); } },
                    ...
                    , __assign({ 
                        ...
                        emoji: emojiDefinition }, emojiSetDef, { 
                        // @ts-expect-error
                        data: emojiData, size: 13 }))),
                    "\u00A0"),
                tooltipReactionType === ((_a = getOptionForType(reactionType)) === null || _a === void 0 ? void 0 : _a.id) && (React__default['default'].createElement("div", { className: 'str-chat__simple-reactions-list-tooltip' },
                    React__default['default'].createElement("div", { className: 'arrow' }), (_b = getUsersPerReactionType(tooltipReactionType)) === null || _b === void 0 ? void 0 :
                    _b.join(', '))))) : null;
        }),
        (reactions === null || reactions === void 0 ? void 0 : reactions.length) !== 0 && (React__default['default'].createElement("li", { className: 'str-chat__simple-reactions-list-item--last-number' }, getTotalReactionCount()))));
};
...
var UnMemoizedMessageTextComponent = function (props) {
    var _a;
    var customInnerClass = props.customInnerClass, customOptionProps = props.customOptionProps, customWrapperClass = props.customWrapperClass, message = props.message, propOnMentionsClick = props.onMentionsClickMessage, propOnMentionsHover = props.onMentionsHoverMessage, _b = props.ReactionsList, ReactionsList$1 = _b === void 0 ? ReactionsList : _b, _c = props.ReactionSelector, ReactionSelector$1 = _c === void 0 ? ReactionSelector : _c, reactionSelectorRef = props.reactionSelectorRef, _d = props.renderText, renderText$1 = _d === void 0 ? renderText : _d, _e = props.theme, theme = _e === void 0 ? 'simple' : _e, unsafeHTML = props.unsafeHTML;
    var _f = useTranslationContext(), t = _f.t, userLanguage = _f.userLanguage;
    var handleMobilePress = useMobilePress().handleMobilePress;
    var _g = useMentionsUIHandler(message, {
        onMentionsClick: propOnMentionsClick,
        onMentionsHover: propOnMentionsHover,
    }), onMentionsClick = _g.onMentionsClick, onMentionsHover = _g.onMentionsHover;
    var _h = useReactionClick(message, reactionSelectorRef), isReactionEnabled = _h.isReactionEnabled, onReactionListClick = _h.onReactionListClick, showDetailedReactions = _h.showDetailedReactions;
    ...
    return (React__default['default'].createElement("div", { className: wrapperClass },
        React__default['default'].createElement("div", { className: ("\n          " + innerClass + "\n          " + (hasAttachment ? " str-chat__message-" + theme + "-text-inner--has-attachment" : '') + "\n          " + (isOnlyEmojis(message.text) ? " str-chat__message-" + theme + "-text-inner--is-emoji" : '') + "\n        ").trim(), "data-testid": 'message-text-inner-wrapper', onClick: onMentionsClick, onMouseOver: onMentionsHover },
            ...
            hasReactions && !showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions, reverse: true })),
            showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef }))),
        React__default['default'].createElement(MessageOptions, __assign({}, props, customOptionProps, { onReactionListClick: onReactionListClick }))));
};
...
var EmojiPicker = function (props) {
    var emojiPickerIsOpen = props.emojiPickerIsOpen, emojiPickerRef = props.emojiPickerRef, onSelectEmoji = props.onSelectEmoji, small = props.small;
    var emojiConfig = useChannelContext().emojiConfig;
    var t = useTranslationContext().t;
    var _a = emojiConfig || {}, emojiData = _a.emojiData, Picker = _a.EmojiPicker;
    if (emojiPickerIsOpen && emojiData) {
        var className = small
            ? 'str-chat__small-message-input-emojipicker'
            : 'str-chat__input--emojipicker';
        return (React__default['default'].createElement("div", { className: className, ref: emojiPickerRef }, Picker && (React__default['default'].createElement(Picker, { color: '#006CFF', data: emojiData, emoji: 'point_up', emojisToShowFilter: filterEmoji, native: true, onSelect: onSelectEmoji, set: 'facebook', showPreview: false, showSkinTones: false, title: t('Pick your emoji'), useButton: true }))));
    }
    return null;
};
...
var messageInputReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case 'setImageUpload': {
            ...
            return __assign(__assign({}, state), { imageOrder: imageOrder, imageUploads: __assign(__assign({}, state.imageUploads), (_a = {}, _a[action.id] = __assign(__assign({}, state.imageUploads[action.id]), newUploadFields), _a)), numberOfUploads: imageAlreadyExists ? state.numberOfUploads : state.numberOfUploads + 1 });
        }
        case 'setFileUpload': {
            ...
            var newUploadFields = __assign({}, action);
            delete newUploadFields.type;
            return __assign(__assign({}, state), { fileOrder: fileOrder, fileUploads: __assign(__assign({}, state.fileUploads), (_b = {}, _b[action.id] = __assign(__assign({}, state.fileUploads[action.id]), newUploadFields), _b)), numberOfUploads: fileAlreadyExists ? state.numberOfUploads : state.numberOfUploads + 1 });
        }
        case 'removeImageUpload': {
            ...
            return __assign(__assign({}, state), { imageOrder: state.imageOrder.filter(function (_id) { return _id !== action.id; }), imageUploads: newImageUploads, numberOfUploads: state.numberOfUploads - 1 });
        }
        case 'removeFileUpload': {
            ...
            return __assign(__assign({}, state), { fileOrder: state.fileOrder.filter(function (_id) { return _id !== action.id; }), fileUploads: newFileUploads, numberOfUploads: state.numberOfUploads - 1 });
        }
        case 'reduceNumberOfUploads': // TODO: figure out if we can just use uploadOrder instead
            return __assign(__assign({}, state), { numberOfUploads: state.numberOfUploads - 1 });
 ...
 */
var useMessageInput = function (props) {
    var _a, _b;
    var additionalTextareaProps = props.additionalTextareaProps, clearEditingState = props.clearEditingState, doFileUploadRequest = props.doFileUploadRequest, doImageUploadRequest = props.doImageUploadRequest, errorHandler = props.errorHandler, focus = props.focus, message = props.message, noFiles = props.noFiles, overrideSubmitHandler = props.overrideSubmitHandler, parent = props.parent, publishTypingEvent = props.publishTypingEvent;
    var _c = useChannelContext(), channel = _c.channel, editMessage = _c.editMessage, maxNumberOfFiles = _c.maxNumberOfFiles, multipleUploads = _c.multipleUploads, sendMessage = _c.sendMessage;
    var _d = React.useReducer(messageInputReducer, message, initState), state = _d[0], dispatch = _d[1];
    var attachments = state.attachments, fileOrder = state.fileOrder, fileUploads = state.fileUploads, imageOrder = state.imageOrder, imageUploads = state.imageUploads, mentioned_users = state.mentioned_users, numberOfUploads = state.numberOfUploads, text = state.text;
    ...
    // Commands / mentions
    var getCommands = React.useCallback(function () { var _a, _b; return (_b = (_a = channel === null || channel === void 0 ? void 0 : channel.getConfig) === null || _a === void 0 ? void 0 : _a.call(channel)) === null || _b === void 0 ? void 0 : _b.commands; }, [channel]);
    var getUsers = React.useCallback(function () {
        ...
        return __spreadArrays(Object.values(channel.state.members).map(function (_a) {
            var user = _a.user;
            return user;
        }), Object.values(channel.state.watchers)).filter(function (_user, index, self) { return self.findIndex(function (user) { return (user === null || user === void 0 ? void 0 : user.id) === (_user === null || _user === void 0 ? void 0 : _user.id); }) === index; });
    }, [channel]);
    ...
    var handleSubmit = function (event) {
        ...
        if (channel && publishTypingEvent)
            streamChat.logChatPromiseExecution(channel.stopTyping(), 'stop typing');
    };
    // Attachments
    // Files
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    if (!alreadyRemoved && errorHandler) {
                        // TODO: verify if the parameters passed to the error handler actually make sense
                        errorHandler(error_2, 'upload-image', __assign(__assign({}, file), { id: id }));
                    }
                    return [2 /*return*/];
                case 7:
                    // If doImageUploadRequest returns any falsy value, then don't create the upload preview.
    ...
    var maxFilesAllowed = React.useMemo(function () { return (!multipleUploads ? 1 : maxNumberOfFiles || apiMaxNumberOfFiles); }, [maxNumberOfFiles, multipleUploads]);
    ...
    return __assign(__assign({}, state), { 
         ...
         * and just forced to not have warnings currently with the unknown casting
         */
        closeEmojiPicker: closeEmojiPicker, emojiPickerRef: emojiPickerRef,
...
var EmojiIconSmall = function () {
    ...
    return (React__default['default'].createElement("svg", { height: '14', width: '14', xmlns: 'http://www.w3.org/2000/svg' },
        React__default['default'].createElement("title", null, t('Open emoji picker')),
        React__default['default'].createElement("path", { d: 'M11.108 8.05a.496.496 0 0 1 .212.667C10.581 10.147 8.886 11 7 11c-1.933 0-3.673-.882-4.33-2.302a.497.497 0 0 1 .9-.417C4.068 9.357 5.446 10 7 10c1.519 0 2.869-.633 3.44-1.738a.495.495 0 0 1 .668-.212zm.792-1.826a.477.477 0 0 1-.119.692.541.541 0 0 1-.31.084.534.534 0 0 1-.428-.194c-.106-.138-.238-.306-.539-.306-.298 0-.431.168-.54.307A.534.534 0 0 1 9.538 7a.544.544 0 0 1-.31-.084.463.463 0 0 1-.117-.694c.33-.423.742-.722 1.394-.722.653 0 1.068.3 1.396.724zm-7 0a.477.477 0 0 1-.119.692.541.541 0 0 1-.31.084.534.534 0 0 1-.428-.194c-.106-.138-.238-.306-.539-.306-.299 0-.432.168-.54.307A.533.533 0 0 1 2.538 7a.544.544 0 0 1-.31-.084.463.463 0 0 1-.117-.694c.33-.423.742-.722 1.394-.722.653 0 1.068.3 1.396.724zM7 0a7 7 0 1 1 0 14A7 7 0 0 1 7 0zm4.243 11.243A5.96 5.96 0 0 0 13 7a5.96 5.96 0 0 0-1.757-4.243A5.96 5.96 0 0 0 7 1a5.96 5.96 0 0 0-4.243 1.757A5.96 5.96 0 0 0 1 7a5.96 5.96 0 0 0 1.757 4.243A5.96 5.96 0 0 0 7 13a5.96 5.96 0 0 0 4.243-1.757z', fillRule: 'evenodd' })));
};
...
var UploadsPreview = function (props) {
    var fileOrder = props.fileOrder, fileUploads = props.fileUploads, imageOrder = props.imageOrder, imageUploads = props.imageUploads, numberOfUploads = props.numberOfUploads, removeFile = props.removeFile, removeImage = props.removeImage, uploadFile = props.uploadFile, uploadImage = props.uploadImage, uploadNewFiles = props.uploadNewFiles;
    var channelContext = useChannelContext();
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        imageOrder.length > 0 && (React__default['default'].createElement(reactFileUtils.ImagePreviewer, { disabled: channelContext.maxNumberOfFiles !== undefined &&
                numberOfUploads >= channelContext.maxNumberOfFiles, handleFiles: uploadNewFiles, handleRemove: removeImage, handleRetry: uploadImage, imageUploads: imagesToPreview, multiple: channelContext.multipleUploads })),
...
var UnMemoizedChatAutoComplete = function (props) {
    var _a, _b;
    var additionalTextareaProps = props.additionalTextareaProps, commands = props.commands, disabled = props.disabled, disableMentions = props.disableMentions, grow = props.grow, handleSubmit = props.handleSubmit, innerRef = props.innerRef, maxRows = props.maxRows, _c = props.mentionAllAppUsers, mentionAllAppUsers = _c === void 0 ? false : _c, _d = props.mentionQueryParams, mentionQueryParams = _d === void 0 ? {} : _d, onChange = props.onChange, onFocus = props.onFocus, onPaste = props.onPaste, onSelectItem = props.onSelectItem, placeholder = props.placeholder, _e = props.rows, rows = _e === void 0 ? 3 : _e, SuggestionItem = props.SuggestionItem, SuggestionList = props.SuggestionList, triggers = props.triggers, value = props.value;
    var _f = useChannelContext(), channel = _f.channel, emojiConfig = _f.emojiConfig;
    var _g = useChatContext(), client = _g.client, mutes = _g.mutes;
    ...
    var _j = emojiConfig || {}, emojiData = _j.emojiData, EmojiIndex = _j.EmojiIndex;
    ...
    var getMembersAndWatchers = React.useCallback(function () {
        ...
        var users = __spreadArrays(memberUsers, watcherUsers);
    ...
    var queryMembersDebounced = React.useCallback(debounce__default['default'](function (query, onReady) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var queryUsersDebounced = debounce__default['default'](queryUsers, 200);
    /**
     ...
     */
    var getTriggers = React.useCallback(function () {
        return triggers ||
            {
                '/': {
                ...
                '@': {
                    callback: function (item) { return onSelectItem && onSelectItem(item); },
                    component: UserItem,
                    dataProvider: function (query, _, onReady) {
    ...
    return (React__default['default'].createElement(ReactTextareaAutocomplete, { additionalTextareaProps: additionalTextareaProps, className: 'str-chat__textarea__textarea', containerClassName: 'str-chat__textarea', disabled: disabled, disableMentions: disableMentions, dropdownClassName: 'str-chat__emojisearch', grow: grow, handleSubmit: handleSubmit, innerRef: updateInnerRef, itemClassName: 'str-chat__emojisearch__item', listClassName: 'str-chat__emojisearch__list', loadingComponent: LoadingIndicator, maxRows: maxRows, minChar: 0, mutes: mutes, onChange: onChange, onFocus: onFocus, onPaste: onPaste, placeholder: placeholder, replaceWord: emojiReplace, rows: rows, SuggestionItem: SuggestionItem, SuggestionList: SuggestionList, trigger: getTriggers(), value: value }));
};
...
var EditMessageForm = function (props) {
    var _a = props.additionalTextareaProps, additionalTextareaProps = _a === void 0 ? {} : _a, clearEditingState = props.clearEditingState, _b = props.disabled, disabled = _b === void 0 ? false : _b, _c = props.EmojiIcon, EmojiIcon = _c === void 0 ? EmojiIconSmall : _c, _d = props.FileUploadIcon, FileUploadIcon$1 = _d === void 0 ? FileUploadIcon : _d, _e = props.focus, focus = _e === void 0 ? false : _e, _f = props.grow, grow = _f === void 0 ? true : _f, _g = props.maxRows, maxRows = _g === void 0 ? 10 : _g, mentionAllAppUsers = props.mentionAllAppUsers, mentionQueryParams = props.mentionQueryParams, _h = props.publishTypingEvent, publishTypingEvent = _h === void 0 ? true : _h;
    var channelContext = useChannelContext();
    var t = useTranslationContext().t;
    var messageInput = useMessageInput(__assign(__assign({}, props), { additionalTextareaProps: additionalTextareaProps,
        disabled: disabled,
        focus: focus,
        grow: grow,
        maxRows: maxRows,
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__edit-message-form' },
        React__default['default'].createElement(reactFileUtils.ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React__default['default'].createElement("form", { onSubmit: messageInput.handleSubmit },
                messageInput.isUploadEnabled && React__default['default'].createElement(UploadsPreview, __assign({}, messageInput)),
                React__default['default'].createElement(EmojiPicker, __assign({}, messageInput, { small: true })),
                React__default['default'].createElement(ChatAutoComplete, { additionalTextareaProps: additionalTextareaProps, commands: messageInput.getCommands(), grow: grow, handleSubmit: messageInput.handleSubmit, innerRef: messageInput.textareaRef, maxRows: maxRows, mentionAllAppUsers: mentionAllAppUsers, mentionQueryParams: mentionQueryParams, onChange: messageInput.handleChange, onPaste: messageInput.onPaste, onSelectItem: messageInput.onSelectItem, placeholder: t('Type your message'), rows: 1, value: messageInput.text }),
                React__default['default'].createElement("div", { className: 'str-chat__message-team-form-footer' },
                    React__default['default'].createElement("div", { className: 'str-chat__edit-message-form-options' },
                        React__default['default'].createElement("span", { className: 'str-chat__input-emojiselect', onClick: messageInput.openEmojiPicker },
                            React__default['default'].createElement(EmojiIcon, null)),
                        messageInput.isUploadEnabled && (React__default['default'].createElement("div", { className: 'str-chat__fileupload-wrapper', "data-testid": 'fileinput' },
                            React__default['default'].createElement(Tooltip, null, messageInput.maxFilesLeft
                                ? t('Attach files')
                                : t("You've reached the maximum number of files")),
                            React__default['default'].createElement(reactFileUtils.FileUploadButton, { accepts: channelContext.acceptedFiles, disabled: messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, multiple: channelContext.multipleUploads },
...
var MessageInputLarge = function (props) {
    var _a = props.additionalTextareaProps, additionalTextareaProps = _a === void 0 ? {} : _a, autocompleteTriggers = props.autocompleteTriggers, _b = props.disabled, disabled = _b === void 0 ? false : _b, disableMentions = props.disableMentions, _c = props.EmojiIcon, EmojiIcon = _c === void 0 ? EmojiIconSmall : _c, _d = props.FileUploadIcon, FileUploadIcon$1 = _d === void 0 ? FileUploadIcon : _d, _e = props.focus, focus = _e === void 0 ? false : _e, _f = props.grow, grow = _f === void 0 ? true : _f, _g = props.maxRows, maxRows = _g === void 0 ? 10 : _g, mentionAllAppUsers = props.mentionAllAppUsers, mentionQueryParams = props.mentionQueryParams, _h = props.publishTypingEvent, publishTypingEvent = _h === void 0 ? true : _h, _j = props.SendButton, SendButton$1 = _j === void 0 ? SendButton : _j, SuggestionItem = props.SuggestionItem, SuggestionList = props.SuggestionList;
    var _k = useChannelContext(), acceptedFiles = _k.acceptedFiles, client = _k.client, multipleUploads = _k.multipleUploads, typing = _k.typing, watcher_count = _k.watcher_count;
    var t = useTranslationContext().t;
    var messageInput = useMessageInput(__assign(__assign({}, props), { additionalTextareaProps: additionalTextareaProps,
        focus: focus,
        publishTypingEvent: publishTypingEvent }));
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__input-large' },
        React__default['default'].createElement(reactFileUtils.ImageDropzone, { accept: acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: multipleUploads },
            React__default['default'].createElement("div", { className: 'str-chat__input' },
                React__default['default'].createElement("div", { className: 'str-chat__input--textarea-wrapper' },
                    messageInput.isUploadEnabled && React__default['default'].createElement(UploadsPreview, __assign({}, messageInput)),
                    React__default['default'].createElement(ChatAutoComplete, { additionalTextareaProps: additionalTextareaProps, commands: messageInput.getCommands(), disabled: disabled, disableMentions: disableMentions, grow: grow, handleSubmit: messageInput.handleSubmit, innerRef: messageInput.textareaRef, maxRows: maxRows, mentionAllAppUsers: mentionAllAppUsers, mentionQueryParams: mentionQueryParams, onChange: messageInput.handleChange, onPaste: messageInput.onPaste, onSelectItem: messageInput.onSelectItem, placeholder: t('Type your message'), rows: 1, SuggestionItem: SuggestionItem, SuggestionList: SuggestionList, triggers: autocompleteTriggers, value: messageInput.text }),
                    messageInput.isUploadEnabled && (React__default['default'].createElement("div", { className: 'str-chat__fileupload-wrapper', "data-testid": 'fileinput' },
                        React__default['default'].createElement(Tooltip, null, messageInput.maxFilesLeft
                            ? t('Attach files')
                            : t("You've reached the maximum number of files")),
                        React__default['default'].createElement(reactFileUtils.FileUploadButton, { accepts: acceptedFiles, disabled: messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, multiple: multipleUploads },
                            React__default['default'].createElement("span", { className: 'str-chat__input-fileupload' },
                                React__default['default'].createElement(FileUploadIcon$1, null))))),
                    React__default['default'].createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React__default['default'].createElement(Tooltip, null, messageInput.emojiPickerIsOpen ? t('Close emoji picker') : t('Open emoji picker')),
                        React__default['default'].createElement("span", { className: 'str-chat__input-emojiselect', onClick: messageInput.emojiPickerIsOpen
                                ? messageInput.closeEmojiPicker
                                : messageInput.openEmojiPicker, onKeyDown: messageInput.handleEmojiKeyDown, ref: messageInput.emojiPickerRef, role: 'button', tabIndex: 0 },
                            React__default['default'].createElement(EmojiIcon, null))),
                    React__default['default'].createElement(EmojiPicker, __assign({}, messageInput))),
                React__default['default'].createElement(SendButton$1, { sendMessage: messageInput.handleSubmit })),
            React__default['default'].createElement("div", null,
                React__default['default'].createElement("div", { className: 'str-chat__input-footer' },
                    React__default['default'].createElement("span", { className: "str-chat__input-footer--count " + (!watcher_count ? 'str-chat__input-footer--count--hidden' : '') }, t('{{ watcherCount }} online', {
                        watcherCount: watcher_count,
                    })),
                    React__default['default'].createElement("span", { className: 'str-chat__input-footer--typing' }, constructTypingString(typing || {})))))));
};

var UnMemoizedMessageInput = function (props) {
    var _a = props.additionalTextareaProps, additionalTextareaProps = _a === void 0 ? {} : _a, _b = props.disabled, disabled = _b === void 0 ? false : _b, _c = props.focus, focus = _c === void 0 ? false : _c, _d = props.grow, grow = _d === void 0 ? true : _d, _e = props.Input, Input = _e === void 0 ? MessageInputLarge : _e, _f = props.maxRows, maxRows = _f === void 0 ? 10 : _f, _g = props.publishTypingEvent, publishTypingEvent = _g === void 0 ? true : _g;
    return (React__default['default'].createElement(Input, __assign({}, props, { additionalTextareaProps: additionalTextareaProps, disabled: disabled, focus: focus, grow: grow, maxRows: maxRows, publishTypingEvent: publishTypingEvent })));
};
/**
...
var MessageInputFlat = function (props) {
    var _a = props.additionalTextareaProps, additionalTextareaProps = _a === void 0 ? {} : _a, autocompleteTriggers = props.autocompleteTriggers, _b = props.disabled, disabled = _b === void 0 ? false : _b, disableMentions = props.disableMentions, _c = props.EmojiIcon, EmojiIcon = _c === void 0 ? EmojiIconLarge : _c, _d = props.FileUploadIcon, FileUploadIcon = _d === void 0 ? FileUploadIconFlat : _d, _e = props.focus, focus = _e === void 0 ? false : _e, _f = props.grow, grow = _f === void 0 ? true : _f, _g = props.maxRows, maxRows = _g === void 0 ? 10 : _g, mentionAllAppUsers = props.mentionAllAppUsers, mentionQueryParams = props.mentionQueryParams, _h = props.publishTypingEvent, publishTypingEvent = _h === void 0 ? true : _h, _j = props.SendButton, SendButton$1 = _j === void 0 ? SendButton : _j, SuggestionItem = props.SuggestionItem, SuggestionList = props.SuggestionList;
    var channelContext = useChannelContext();
    var t = useTranslationContext().t;
    var messageInput = useMessageInput(__assign(__assign({}, props), { additionalTextareaProps: additionalTextareaProps,
        disabled: disabled,
        ...
        maxRows: maxRows,
        publishTypingEvent: publishTypingEvent }));
    return (React__default['default'].createElement("div", { className: "str-chat__input-flat " + (SendButton$1 ? 'str-chat__input-flat--send-button-active' : null) },
        React__default['default'].createElement(reactFileUtils.ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React__default['default'].createElement("div", { className: 'str-chat__input-flat-wrapper' },
                React__default['default'].createElement("div", { className: 'str-chat__input-flat--textarea-wrapper' },
                    ...
                    React__default['default'].createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React__default['default'].createElement(Tooltip, null, messageInput.emojiPickerIsOpen ? t('Close emoji picker') : t('Open emoji picker')),
                        React__default['default'].createElement("span", { className: 'str-chat__input-flat-emojiselect', onClick: messageInput.emojiPickerIsOpen
                                ? messageInput.closeEmojiPicker
                                : messageInput.openEmojiPicker, onKeyDown: messageInput.handleEmojiKeyDown, role: 'button', tabIndex: 0 },
                            React__default['default'].createElement(EmojiIcon, null))),
                    React__default['default'].createElement(EmojiPicker, __assign({}, messageInput)),
                    React__default['default'].createElement(ChatAutoComplete, { additionalTextareaProps: additionalTextareaProps, commands: messageInput.getCommands(), disabled: disabled, disableMentions: disableMentions, grow: grow, handleSubmit: messageInput.handleSubmit, innerRef: messageInput.textareaRef, maxRows: maxRows, mentionAllAppUsers: mentionAllAppUsers, mentionQueryParams: mentionQueryParams, onChange: messageInput.handleChange, onPaste: messageInput.onPaste, onSelectItem: messageInput.onSelectItem, placeholder: t('Type your message'), rows: 1, SuggestionItem: SuggestionItem, SuggestionList: SuggestionList, triggers: autocompleteTriggers, value: messageInput.text }),
                    messageInput.isUploadEnabled && (React__default['default'].createElement("div", { className: 'str-chat__fileupload-wrapper', "data-testid": 'fileinput' },
                ...
                SendButton$1 && React__default['default'].createElement(SendButton$1, { sendMessage: messageInput.handleSubmit })))));
};

var MessageInputSimple = function (props) {
    var _a = props.additionalTextareaProps, additionalTextareaProps = _a === void 0 ? {} : _a, autocompleteTriggers = props.autocompleteTriggers, _b = props.disabled, disabled = _b === void 0 ? false : _b, disableMentions = props.disableMentions, _c = props.EmojiIcon, EmojiIcon = _c === void 0 ? EmojiIconLarge : _c, _d = props.focus, focus = _d === void 0 ? false : _d, _e = props.grow, grow = _e === void 0 ? true : _e, _f = props.maxRows, maxRows = _f === void 0 ? 10 : _f, mentionAllAppUsers = props.mentionAllAppUsers, mentionQueryParams = props.mentionQueryParams, _g = props.publishTypingEvent, publishTypingEvent = _g === void 0 ? true : _g, _h = props.SendButton, SendButton$1 = _h === void 0 ? SendButton : _h, SuggestionItem = props.SuggestionItem, SuggestionList = props.SuggestionList;
    var t = useTranslationContext().t;
    var messageInput = useMessageInput(__assign(__assign({}, props), { additionalTextareaProps: additionalTextareaProps,
        disabled: disabled,
        focus: focus,
...
var MessageInputSmall = function (props) {
    var _a = props.additionalTextareaProps, additionalTextareaProps = _a === void 0 ? {} : _a, autocompleteTriggers = props.autocompleteTriggers, _b = props.disabled, disabled = _b === void 0 ? false : _b, disableMentions = props.disableMentions, _c = props.EmojiIcon, EmojiIcon = _c === void 0 ? EmojiIconSmall : _c, _d = props.FileUploadIcon, FileUploadIcon = _d === void 0 ? FileUploadIconFlat : _d, _e = props.focus, focus = _e === void 0 ? false : _e, _f = props.grow, grow = _f === void 0 ? true : _f, _g = props.maxRows, maxRows = _g === void 0 ? 10 : _g, mentionAllAppUsers = props.mentionAllAppUsers, mentionQueryParams = props.mentionQueryParams, _h = props.publishTypingEvent, publishTypingEvent = _h === void 0 ? true : _h, _j = props.SendButton, SendButton$1 = _j === void 0 ? SendButton : _j, SuggestionItem = props.SuggestionItem, SuggestionList = props.SuggestionList;
    var channelContext = useChannelContext();
    var t = useTranslationContext().t;
    var messageInput = useMessageInput(__assign(__assign({}, props), { additionalTextareaProps: additionalTextareaProps,
        disabled: disabled,
        ...
        React__default['default'].createElement(reactFileUtils.ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React__default['default'].createElement("div", { className: "str-chat__small-message-input " + (SendButton$1 ? 'str-chat__small-message-input--send-button-active' : null) },
                React__default['default'].createElement("div", { className: 'str-chat__small-message-input--textarea-wrapper' },
                    ...
                    React__default['default'].createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React__default['default'].createElement(Tooltip, null, messageInput.emojiPickerIsOpen ? t('Close emoji picker') : t('Open emoji picker')),
                        React__default['default'].createElement("span", { className: 'str-chat__small-message-input-emojiselect', onClick: messageInput.emojiPickerIsOpen
                                ? messageInput.closeEmojiPicker
                                : messageInput.openEmojiPicker, onKeyDown: messageInput.handleEmojiKeyDown, role: 'button', tabIndex: 0 },
                            React__default['default'].createElement(EmojiIcon, null))),
                    React__default['default'].createElement(EmojiPicker, __assign({}, messageInput, { small: true }))),
...
var MessageSimpleWithContext = function (props) {
    var additionalMessageInputProps = props.additionalMessageInputProps, Attachment = props.Attachment, _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, clearEditingState = props.clearEditingState, editing = props.editing, _b = props.EditMessageInput, EditMessageInput = _b === void 0 ? EditMessageForm : _b, formatDate = props.formatDate, getMessageActions = props.getMessageActions, handleAction = props.handleAction, handleOpenThread = props.handleOpenThread, handleReaction = props.handleReaction, handleRetry = props.handleRetry, isMyMessage = props.isMyMessage, isReactionEnabled = props.isReactionEnabled, message = props.message, _c = props.MessageDeleted, MessageDeleted$1 = _c === void 0 ? MessageDeleted : _c, onReactionListClick = props.onReactionListClick, onUserClick = props.onUserClick, onUserHover = props.onUserHover, _d = props.ReactionSelector, ReactionSelector$1 = _d === void 0 ? ReactionSelector : _d, reactionSelectorRef = props.reactionSelectorRef, _e = props.ReactionsList, ReactionsList$1 = _e === void 0 ? ReactionsList : _e, showDetailedReactions = props.showDetailedReactions, threadList = props.threadList;
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        message && (React__default['default'].createElement("div", { className: ("\n\t\t\t\t\t\t" + messageClasses + "\n\t\t\t\t\t\tstr-chat__message--" + message.type + "\n\t\t\t\t\t\tstr-chat__message--" + message.status + "\n\t\t\t\t\t\t" + (message.text ? 'str-chat__message--has-text' : 'has-no-text') + "\n\t\t\t\t\t\t" + (hasAttachment ? 'str-chat__message--has-attachment' : '') + "\n            " + (hasReactions && isReactionEnabled ? 'str-chat__message--with-reactions' : '') + "\n            " + (message.pinned ? 'pinned-message' : '') + "\n\t\t\t\t\t").trim(), key: message.id || '', ref: messageWrapperRef },
            React__default['default'].createElement(MessageSimpleStatus, __assign({}, props)),
            message.user && (React__default['default'].createElement(Avatar$1, { image: message.user.image, name: message.user.name || message.user.id, onClick: onUserClick, onMouseOver: onUserHover })),
            React__default['default'].createElement("div", { className: 'str-chat__message-inner', "data-testid": 'message-inner', onClick: message.status === 'failed' && message.errorStatusCode !== 403
                    ...
                    : undefined },
                !message.text && (React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement(MessageOptions, __assign({}, props, { handleOpenThread: handleOpenThread, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick })),
                    hasReactions && !showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions, reverse: true })),
                    showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef })))),
                message.attachments && Attachment && (React__default['default'].createElement(Attachment, { actionHandler: handleAction, attachments: message.attachments })),
                message.text && (React__default['default'].createElement(MessageText, __assign({}, props, { customOptionProps: {
                ...
                !threadList && message.reply_count !== 0 && (React__default['default'].createElement("div", { className: 'str-chat__message-simple-reply-button' },
                    React__default['default'].createElement(MessageRepliesCountButton, { onClick: handleOpenThread, reply_count: message.reply_count }))),
                React__default['default'].createElement("div", { className: "str-chat__message-data str-chat__message-simple-data" },
                    ...
                    React__default['default'].createElement(MessageTimestamp, { calendar: true, customClass: 'str-chat__message-simple-timestamp', formatDate: formatDate, message: message })))))));
};
var MessageSimpleStatus = function (_a) {
    var _b;
    var _c = _a.Avatar, Avatar$1 = _c === void 0 ? Avatar : _c, isMyMessage = _a.isMyMessage, readBy = _a.readBy, message = _a.message, threadList = _a.threadList, lastReceivedId = _a.lastReceivedId;
    var client = useChatContext().client;
    var t = useTranslationContext().t;
    ...
    if (message && message.status === 'sending') {
        return (React__default['default'].createElement("span", { className: 'str-chat__message-simple-status', "data-testid": 'message-status-sending' },
    ...
    if (readBy && readBy.length !== 0 && !threadList && !justReadByMe) {
        var lastReadUser = readBy.filter(function (item) { var _a; return !!item && !!client && item.id !== ((_a = client.user) === null || _a === void 0 ? void 0 : _a.id); })[0];
        return (React__default['default'].createElement("span", { className: 'str-chat__message-simple-status', "data-testid": 'message-status-read-by' },
            React__default['default'].createElement(Tooltip, null, readBy && getReadByTooltipText(readBy, t, client)),
            React__default['default'].createElement(Avatar$1, { image: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.image, name: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.name, size: 15 }),
            readBy.length > 2 && (React__default['default'].createElement("span", { className: 'str-chat__message-simple-status-number', "data-testid": 'message-status-read-by-many' }, readBy.length - 1))));
    }
    if (message && message.status === 'received' && message.id === lastReceivedId && !threadList) {
        return (React__default['default'].createElement("span", { className: 'str-chat__message-simple-status', "data-testid": 'message-status-received' },
...
var MessageSimple = function (props) {
    var PropAttachment = props.Attachment, message = props.message;
    var ContextAttachment = useChannelContext().Attachment;
    var reactionSelectorRef = React.useRef(null);
    var _a = useReactionClick(message, reactionSelectorRef), isReactionEnabled = _a.isReactionEnabled, onReactionListClick = _a.onReactionListClick, showDetailedReactions = _a.showDetailedReactions;
    var Attachment$1 = PropAttachment || ContextAttachment || Attachment;
    return (React__default['default'].createElement(MemoizedMessageSimple, __assign({}, props, { Attachment: Attachment$1, isReactionEnabled: isReactionEnabled, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};

var MessageWithContext = function (props) {
    var canPin = props.canPin, channel = props.channel, formatDate = props.formatDate, _a = props.groupStyles, groupStyles = _a === void 0 ? [] : _a, handleAction = props.handleAction, handleDelete = props.handleDelete, handleFlag = props.handleFlag, handleMute = props.handleMute, handleOpenThread = props.handleOpenThread, handlePin = props.handlePin, handleReaction = props.handleReaction, handleRetry = props.handleRetry, _b = props.Message, MessageUIComponent = _b === void 0 ? MessageSimple : _b, message = props.message, _c = props.messageActions, messageActions = _c === void 0 ? Object.keys(MESSAGE_ACTIONS) : _c, onMentionsClickMessage = props.onMentionsClickMessage, onMentionsHoverMessage = props.onMentionsHoverMessage, propOnUserClick = props.onUserClick, propOnUserHover = props.onUserHover, userRoles = props.userRoles;
    var channelConfig = channel.getConfig && channel.getConfig();
    var _d = useEditHandler(), clearEdit = _d.clearEdit, editing = _d.editing, setEdit = _d.setEdit;
    var _e = useUserHandler(message, {
        onUserClickHandler: propOnUserClick,
        onUserHoverHandler: propOnUserHover,
    }), onUserClick = _e.onUserClick, onUserHover = _e.onUserHover;
    var isAdmin = userRoles.isAdmin, isModerator = userRoles.isModerator, isMyMessage = userRoles.isMyMessage;
    var canEdit = isMyMessage || isModerator || isAdmin;
    ...
    var messageActionsHandler = React.useCallback(function () {
        ...
        return getMessageActions(messageActions, {
            ...
            canEdit: canEdit,
            canFlag: !isMyMessage,
            canMute: !isMyMessage && !!(channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.mutes),
            canPin: canPin,
            canReact: canReact,
            canReply: canReply,
        });
        ...
        canReply,
        canReact,
        channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.mutes,
        isMyMessage,
        message,
        messageActions,
    ]);
    var actionsEnabled = message && message.type === 'regular' && message.status === 'received';
    return (React__default['default'].createElement(MessageUIComponent, __assign({}, props, { actionsEnabled: actionsEnabled, channelConfig: channelConfig, clearEditingState: clearEdit, editing: editing, formatDate: formatDate, getMessageActions: messageActionsHandler, groupStyles: groupStyles, handleAction: handleAction, handleDelete: handleDelete, handleEdit: setEdit, handleFlag: handleFlag, handleMute: handleMute, handleOpenThread: handleOpenThread, handlePin: handlePin, handleReaction: handleReaction, handleRetry: handleRetry, isMyMessage: function () { return isMyMessage; }, onMentionsClickMessage: onMentionsClickMessage, onMentionsHoverMessage: onMentionsHoverMessage, onUserClick: onUserClick, onUserHover: onUserHover, setEditingState: setEdit })));
};
...
var Message = function (props) {
    var addNotification = props.addNotification, propChannel = props.channel, getFlagMessageErrorNotification = props.getFlagMessageErrorNotification, getFlagMessageSuccessNotification = props.getFlagMessageSuccessNotification, getMuteUserErrorNotification = props.getMuteUserErrorNotification, getMuteUserSuccessNotification = props.getMuteUserSuccessNotification, getPinMessageErrorNotification = props.getPinMessageErrorNotification, message = props.message, propOnMentionsClick = props.onMentionsClick, propOnMentionsHover = props.onMentionsHover, propOpenThread = props.openThread, _a = props.pinPermissions, pinPermissions = _a === void 0 ? defaultPinPermissions : _a, propRetrySendMessage = props.retrySendMessage;
    ...
    return (React__default['default'].createElement(MemoizedMessage, __assign({}, props, { canPin: canPin, channel: channel, handleAction: handleAction, handleDelete: handleDelete, handleFlag: handleFlag, handleMute: handleMute, handleOpenThread: handleOpenThread, handlePin: handlePin, handleReaction: handleReaction, handleRetry: handleRetry, onMentionsClickMessage: onMentionsClick, onMentionsHoverMessage: onMentionsHover, userRoles: userRoles })));
};

var MessageCommerceWithContext = function (props) {
    var _a, _b, _c, _d, _e;
    var _f = props.Attachment, Attachment$1 = _f === void 0 ? Attachment : _f, _g = props.Avatar, Avatar$1 = _g === void 0 ? Avatar : _g, formatDate = props.formatDate, groupStyles = props.groupStyles, handleAction = props.handleAction, handleOpenThread = props.handleOpenThread, handleReaction = props.handleReaction, isMyMessage = props.isMyMessage, isReactionEnabled = props.isReactionEnabled, message = props.message, _h = props.MessageDeleted, MessageDeleted$1 = _h === void 0 ? MessageDeleted : _h, onReactionListClick = props.onReactionListClick, propOnUserClick = props.onUserClick, propOnUserHover = props.onUserHover, _j = props.ReactionSelector, ReactionSelector$1 = _j === void 0 ? ReactionSelector : _j, reactionSelectorRef = props.reactionSelectorRef, _k = props.ReactionsList, ReactionsList$1 = _k === void 0 ? ReactionsList : _k, showDetailedReactions = props.showDetailedReactions, threadList = props.threadList;
    var _l = useUserHandler(message, {
        onUserClickHandler: propOnUserClick,
        onUserHoverHandler: propOnUserHover,
    }), onUserClick = _l.onUserClick, onUserHover = _l.onUserHover;
    var hasAttachment = messageHasAttachments(message);
    var hasReactions = messageHasReactions(message);
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("div", { className: ("\n\t\t\t\t\t\t" + messageClasses + "\n\t\t\t\t\t\tstr-chat__message-commerce--" + message.type + "\n\t\t\t\t\t\t" + (message.text ? 'str-chat__message-commerce--has-text' : 'str-chat__message-commerce--has-no-text') + "\n\t\t\t\t\t\t" + (hasAttachment ? 'str-chat__message-commerce--has-attachment' : '') + "\n            " + (hasReactions && isReactionEnabled ? 'str-chat__message-commerce--with-reactions' : '') + "\n            " + ("str-chat__message-commerce--" + firstGroupStyle) + "\n            " + (message.pinned ? 'pinned-message' : '') + "\n\t\t\t\t\t").trim(), "data-testid": 'message-commerce-wrapper', key: message.id },
            (firstGroupStyle === 'bottom' || firstGroupStyle === 'single') && (React__default['default'].createElement(Avatar$1, { image: (_a = message.user) === null || _a === void 0 ? void 0 : _a.image, name: ((_b = message.user) === null || _b === void 0 ? void 0 : _b.name) || ((_c = message.user) === null || _c === void 0 ? void 0 : _c.id), onClick: onUserClick, onMouseOver: onUserHover, size: 32 })),
            React__default['default'].createElement("div", { className: 'str-chat__message-commerce-inner' },
                message && !message.text && (React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement(MessageOptions, __assign({}, props, { displayActions: false, displayLeft: false, displayReplies: false, onReactionListClick: onReactionListClick, theme: 'commerce' })),
                    hasReactions && !showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
                    showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef, reverse: false })))),
                message.attachments && (React__default['default'].createElement(Attachment$1, { actionHandler: handleAction, attachments: message.attachments })),
                message.mml && (React__default['default'].createElement(MML, { actionHandler: handleAction, align: isMyMessage() ? 'right' : 'left', source: message.mml })),
                message.text && (React__default['default'].createElement(MessageText, __assign({}, props, { customInnerClass: 'str-chat__message-commerce-text-inner', customOptionProps: {
                        displayActions: false,
                        displayLeft: false,
                        displayReplies: false,
                        theme: 'commerce',
                    }, customWrapperClass: 'str-chat__message-commerce-text', theme: 'commerce' }))),
                ...
                React__default['default'].createElement("div", { className: 'str-chat__message-commerce-data' },
                    !isMyMessage() ? (React__default['default'].createElement("span", { className: 'str-chat__message-commerce-name' }, ((_d = message.user) === null || _d === void 0 ? void 0 : _d.name) || ((_e = message.user) === null || _e === void 0 ? void 0 : _e.id))) : null,
                    React__default['default'].createElement(MessageTimestamp, { customClass: 'str-chat__message-commerce-timestamp', format: 'LT', formatDate: formatDate, message: message }))))));
};
...
var MessageCommerce = function (props) {
    ...
    var reactionSelectorRef = React.useRef(null);
    var _a = useReactionClick(message, reactionSelectorRef), isReactionEnabled = _a.isReactionEnabled, onReactionListClick = _a.onReactionListClick, showDetailedReactions = _a.showDetailedReactions;
    return (React__default['default'].createElement(MemoizedMessageCommerce, __assign({}, props, { isReactionEnabled: isReactionEnabled, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};

var MessageLivestreamWithContext = function (props) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    var addNotification = props.addNotification, _k = props.Attachment, Attachment$1 = _k === void 0 ? Attachment : _k, _l = props.Avatar, Avatar$1 = _l === void 0 ? Avatar : _l, channelConfig = props.channelConfig, clearEditingState = props.clearEditingState, _m = props.EditMessageInput, EditMessageInput = _m === void 0 ? EditMessageForm : _m, editing = props.editing, formatDate = props.formatDate, getMessageActions = props.getMessageActions, groupStyles = props.groupStyles, handleAction = props.handleAction, handleOpenThread = props.handleOpenThread, handleReaction = props.handleReaction, handleRetry = props.handleRetry, initialMessage = props.initialMessage, isReactionEnabled = props.isReactionEnabled, message = props.message, _o = props.MessageDeleted, MessageDeleted$1 = _o === void 0 ? MessageDeleted : _o, messageWrapperRef = props.messageWrapperRef, onMentionsClickMessage = props.onMentionsClickMessage, onMentionsHoverMessage = props.onMentionsHoverMessage, onReactionListClick = props.onReactionListClick, propOnUserClick = props.onUserClick, propOnUserHover = props.onUserHover, _p = props.PinIndicator, PinIndicator$1 = _p === void 0 ? PinIndicator : _p, _q = props.ReactionsList, ReactionsList = _q === void 0 ? SimpleReactionsList : _q, _r = props.ReactionSelector, ReactionSelector$1 = _r === void 0 ? ReactionSelector : _r, reactionSelectorRef = props.reactionSelectorRef, _s = props.renderText, renderText$1 = _s === void 0 ? renderText : _s, threadList = props.threadList, setEditingState = props.setEditingState, showDetailedReactions = props.showDetailedReactions, unsafeHTML = props.unsafeHTML;
    var _t = useTranslationContext(), t = _t.t, userLanguage = _t.userLanguage;
    var _u = useUserHandler(message, {
        onUserClickHandler: propOnUserClick,
        onUserHoverHandler: propOnUserHover,
    }), onUserClick = _u.onUserClick, onUserHover = _u.onUserHover;
    var messageTextToRender = ((_a = message.i18n) === null || _a === void 0 ? void 0 : _a[userLanguage + "_text"]) || message.text;
    var messageText = React.useMemo(function () { return renderText$1(messageTextToRender, message.mentioned_users); }, [
        message.mentioned_users,
        messageTextToRender,
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement("div", { className: "str-chat__message-livestream str-chat__message-livestream--" + firstGroupStyle + " str-chat__message-livestream--" + message.type + " str-chat__message-livestream--" + message.status + " " + (initialMessage ? 'str-chat__message-livestream--initial-message' : '') + " " + (message.pinned ? 'pinned-message' : ''), "data-testid": 'message-livestream', ref: messageWrapperRef },
            showDetailedReactions && isReactionEnabled && (React__default['default'].createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef, reverse: false })),
            React__default['default'].createElement(MessageLivestreamActions, { addNotification: addNotification, channelConfig: channelConfig, formatDate: formatDate, getMessageActions: getMessageActions, handleOpenThread: handleOpenThread, initialMessage: initialMessage, message: message, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick, setEditingState: setEditingState, threadList: threadList }),
                    ...
                    React__default['default'].createElement("div", { className: isOnlyEmojis(message.text) ? 'str-chat__message-livestream-text--is-emoji' : '', "data-testid": 'message-livestream-text', onClick: onMentionsClickMessage, onMouseOver: onMentionsHoverMessage },
                        ...
                        message.status === 'failed' && (React__default['default'].createElement("p", { onClick: message.errorStatusCode !== 403 ? function () { return handleRetry(message); } : undefined },
                            ...
                            message.errorStatusCode !== 403
                                ? t('Message Failed · Click to try again')
                                : t('Message Failed · Unauthorized')))),
                    message.attachments && Attachment$1 && (React__default['default'].createElement(Attachment$1, { actionHandler: handleAction, attachments: message.attachments })),
                    isReactionEnabled && (React__default['default'].createElement(ReactionsList, { handleReaction: handleReaction, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
                    !initialMessage && (React__default['default'].createElement(MessageRepliesCountButton, { onClick: handleOpenThread, reply_count: message.reply_count })))))));
};
var MessageLivestreamActions = function (props) {
    var channelConfig = props.channelConfig, formatDate = props.formatDate, getMessageActions = props.getMessageActions, handleOpenThread = props.handleOpenThread, initialMessage = props.initialMessage, message = props.message, messageWrapperRef = props.messageWrapperRef, onReactionListClick = props.onReactionListClick, threadList = props.threadList;
    var _a = React.useState(false), actionsBoxOpen = _a[0], setActionsBoxOpen = _a[1];
    var hideOptions = React.useCallback(function () { return setActionsBoxOpen(false); }, []);
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__message-livestream-actions", "data-testid": 'message-livestream-actions' },
        React__default['default'].createElement(MessageTimestamp, { customClass: 'str-chat__message-livestream-time', formatDate: formatDate, message: message }),
        (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.reactions) && (React__default['default'].createElement("span", { "data-testid": 'message-livestream-reactions-action', onClick: onReactionListClick },
            React__default['default'].createElement("span", null,
                React__default['default'].createElement(ReactionIcon, null)))),
        !threadList && (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.replies) && (React__default['default'].createElement("span", { "data-testid": 'message-livestream-thread-action', onClick: handleOpenThread },
            React__default['default'].createElement(ThreadIcon, null))),
        showActionsBox && (React__default['default'].createElement(MessageActions, __assign({}, props, { customWrapperClass: '', getMessageActions: getMessageActions, inline: true })))));
};
...
var MessageLivestream = function (props) {
    var message = props.message, propOnMentionsClick = props.onMentionsClickMessage, propOnMentionsHover = props.onMentionsHoverMessage;
    var messageWrapperRef = React.useRef(null);
    var reactionSelectorRef = React.useRef(null);
    var _a = useMentionsUIHandler(message, {
        onMentionsClick: propOnMentionsClick,
        onMentionsHover: propOnMentionsHover,
    }), onMentionsClick = _a.onMentionsClick, onMentionsHover = _a.onMentionsHover;
    var _b = useReactionClick(message, reactionSelectorRef, messageWrapperRef), isReactionEnabled = _b.isReactionEnabled, onReactionListClick = _b.onReactionListClick, showDetailedReactions = _b.showDetailedReactions;
    return (React__default['default'].createElement(MemoizedMessageLivestream, __assign({}, props, { isReactionEnabled: isReactionEnabled, messageWrapperRef: messageWrapperRef, onMentionsClickMessage: onMentionsClick, onMentionsHoverMessage: onMentionsHover, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};

var MessageTeamWithContext = function (props) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    var addNotification = props.addNotification, _l = props.Avatar, Avatar$1 = _l === void 0 ? Avatar : _l, Attachment = props.Attachment, channel = props.channel, propChannelConfig = props.channelConfig, clearEditingState = props.clearEditingState, editing = props.editing, _m = props.EditMessageInput, EditMessageInput = _m === void 0 ? EditMessageForm : _m, formatDate = props.formatDate, getFlagMessageErrorNotification = props.getFlagMessageErrorNotification, getFlagMessageSuccessNotification = props.getFlagMessageSuccessNotification, getMessageActions = props.getMessageActions, getMuteUserErrorNotification = props.getMuteUserErrorNotification, getMuteUserSuccessNotification = props.getMuteUserSuccessNotification, _o = props.groupStyles, groupStyles = _o === void 0 ? ['single'] : _o, handleAction = props.handleAction, handleEdit = props.handleEdit, handleFlag = props.handleFlag, handleDelete = props.handleDelete, handleOpenThread = props.handleOpenThread, handleMute = props.handleMute, handlePin = props.handlePin, handleReaction = props.handleReaction, handleRetry = props.handleRetry, initialMessage = props.initialMessage, isMyMessage = props.isMyMessage, isReactionEnabled = props.isReactionEnabled, lastReceivedId = props.lastReceivedId, message = props.message, _p = props.MessageDeleted, MessageDeleted$1 = _p === void 0 ? MessageDeleted : _p, messageListRect = props.messageListRect, messageWrapperRef = props.messageWrapperRef, onMentionsClickMessage = props.onMentionsClickMessage, onMentionsHoverMessage = props.onMentionsHoverMessage, onReactionListClick = props.onReactionListClick, propOnUserClick = props.onUserClick, propOnUserHover = props.onUserHover, _q = props.PinIndicator, PinIndicator$1 = _q === void 0 ? PinIndicator : _q, _r = props.ReactionsList, ReactionsList = _r === void 0 ? SimpleReactionsList : _r, _s = props.ReactionSelector, ReactionSelector$1 = _s === void 0 ? ReactionSelector : _s, reactionSelectorRef = props.reactionSelectorRef, readBy = props.readBy, _t = props.renderText, renderText$1 = _t === void 0 ? renderText : _t, showDetailedReactions = props.showDetailedReactions, setEditingState = props.setEditingState, threadList = props.threadList, unsafeHTML = props.unsafeHTML;
    var _u = useTranslationContext(), t = _u.t, userLanguage = _u.userLanguage;
    ...
    var _v = useUserHandler(message, {
        onUserClickHandler: propOnUserClick,
        onUserHoverHandler: propOnUserHover,
    }), onUserClick = _v.onUserClick, onUserHover = _v.onUserHover;
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement("div", { className: "str-chat__message-team str-chat__message-team--" + firstGroupStyle + " str-chat__message-team--" + message.type + " " + (threadList ? 'thread-list' : '') + " str-chat__message-team--" + message.status + " " + (message.pinned ? 'pinned-message' : ''), "data-testid": 'message-team', ref: messageWrapperRef },
            React__default['default'].createElement("div", { className: 'str-chat__message-team-meta' },
                ...
                React__default['default'].createElement(MessageTimestamp, { formatDate: formatDate, message: message })),
            React__default['default'].createElement("div", { className: 'str-chat__message-team-group' },
                ...
                React__default['default'].createElement("div", { className: "str-chat__message-team-content str-chat__message-team-content--" + firstGroupStyle + " str-chat__message-team-content--" + (message.text === '' ? 'image' : 'text'), "data-testid": 'message-team-content' },
                    !initialMessage &&
                        ...
                        message && showDetailedReactions && (React__default['default'].createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef })),
                        isReactionEnabled && (React__default['default'].createElement("span", { "data-testid": 'message-team-reaction-icon', onClick: onReactionListClick, title: 'Reactions' },
                            React__default['default'].createElement(ReactionIcon, null))),
                        !threadList && (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.replies) !== false && (React__default['default'].createElement("span", { "data-testid": 'message-team-thread-icon', onClick: handleOpenThread, title: 'Start a thread' },
                            React__default['default'].createElement(ThreadIcon, null))),
                        showActionsBox && (React__default['default'].createElement(MessageActions, { addNotification: addNotification, customWrapperClass: '', getFlagMessageErrorNotification: getFlagMessageErrorNotification, getFlagMessageSuccessNotification: getFlagMessageSuccessNotification, getMessageActions: getMessageActions, getMuteUserErrorNotification: getMuteUserErrorNotification, getMuteUserSuccessNotification: getMuteUserSuccessNotification, handleDelete: handleDelete, handleEdit: handleEdit, handleFlag: handleFlag, handleMute: handleMute, handlePin: handlePin, inline: true, message: message, messageListRect: messageListRect, messageWrapperRef: messageWrapperRef, setEditingState: setEditingState })))),
                    message && (React__default['default'].createElement("span", { className: isOnlyEmojis(message.text) ? 'str-chat__message-team-text--is-emoji' : '', "data-testid": 'message-team-message', onClick: onMentionsClickMessage, onMouseOver: onMentionsHoverMessage }, unsafeHTML && message.html ? (React__default['default'].createElement("div", { dangerouslySetInnerHTML: { __html: message.html } })) : (messageText))),
                    message.mml && React__default['default'].createElement(MML, { actionHandler: handleAction, align: 'left', source: message.mml }),
                    message.text === '' && (React__default['default'].createElement(MessageTeamAttachments, { Attachment: Attachment, handleAction: handleAction, message: message })),
                    ((_k = message.latest_reactions) === null || _k === void 0 ? void 0 : _k.length) !== 0 && message.text !== '' && isReactionEnabled && (React__default['default'].createElement(ReactionsList, { handleReaction: handleReaction, onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
                    message.status === 'failed' && (React__default['default'].createElement("button", { className: 'str-chat__message-team-failed', "data-testid": 'message-team-failed', onClick: message.errorStatusCode !== 403 ? function () { return handleRetry(message); } : undefined },
                        ...
                        message.errorStatusCode !== 403
                            ? t('Message Failed · Click to try again')
                            : t('Message Failed · Unauthorized')))),
                React__default['default'].createElement(MessageTeamStatus, { Avatar: Avatar$1, isMyMessage: isMyMessage, lastReceivedId: lastReceivedId, message: message, readBy: readBy, threadList: threadList }),
                message.text !== '' && message.attachments && (React__default['default'].createElement(MessageTeamAttachments, { Attachment: Attachment, handleAction: handleAction, message: message })),
                message.latest_reactions &&
                    message.latest_reactions.length !== 0 &&
                    message.text === '' &&
                    isReactionEnabled && (React__default['default'].createElement(ReactionsList, { handleReaction: handleReaction, onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
                !threadList && (React__default['default'].createElement(MessageRepliesCountButton, { onClick: handleOpenThread, reply_count: message.reply_count }))))));
};
var MessageTeamStatus = function (props) {
    var _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, isMyMessage = props.isMyMessage, lastReceivedId = props.lastReceivedId, message = props.message, readBy = props.readBy, threadList = props.threadList;
    var client = useChatContext().client;
    var t = useTranslationContext().t;
    if (!isMyMessage() || message.type === 'error') {
        return null;
    ...
    if (message && message.status === 'sending') {
        return (React__default['default'].createElement("span", { className: 'str-chat__message-team-status', "data-testid": 'message-team-sending' },
            React__default['default'].createElement(Tooltip, null, t('Sending...')),
            React__default['default'].createElement(LoadingIndicator, null)));
    }
    if (readBy && readBy.length !== 0 && !threadList && !justReadByMe) {
        var lastReadUser = readBy.filter(function (item) { return item && (client === null || client === void 0 ? void 0 : client.user) && item.id !== client.user.id; })[0];
        return (React__default['default'].createElement("span", { className: 'str-chat__message-team-status' },
            React__default['default'].createElement(Tooltip, null, getReadByTooltipText(readBy, t, client)),
            React__default['default'].createElement(Avatar$1, { image: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.image, name: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.name, size: 15 }),
            readBy.length - 1 > 1 && (React__default['default'].createElement("span", { className: 'str-chat__message-team-status-number', "data-testid": 'message-team-read-by-count' }, readBy.length - 1))));
    }
    if (message && message.status === 'received' && message.id === lastReceivedId && !threadList) {
        return (React__default['default'].createElement("span", { className: 'str-chat__message-team-status', "data-testid": 'message-team-received' },
            React__default['default'].createElement(Tooltip, null, t('Delivered')),
            React__default['default'].createElement(DeliveredCheckIcon, null)));
    }
    return null;
};
var MessageTeamAttachments = function (props) {
    var _a = props.Attachment, Attachment$1 = _a === void 0 ? Attachment : _a, handleAction = props.handleAction, message = props.message;
    if (message.attachments) {
        return React__default['default'].createElement(Attachment$1, { actionHandler: handleAction, attachments: message.attachments });
    }
    return null;
};
...
var MessageTeam = function (props) {
    ...
    return (React__default['default'].createElement(MemoizedMessageTeam, __assign({}, props, { channel: channel, isReactionEnabled: isReactionEnabled, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};
...
var ChannelInner = function (props) {
    var acceptedFiles = props.acceptedFiles, _a = props.Attachment, Attachment$1 = _a === void 0 ? Attachment : _a, channel = props.channel, children = props.children, doMarkReadRequest = props.doMarkReadRequest, doSendMessageRequest = props.doSendMessageRequest, doUpdateMessageRequest = props.doUpdateMessageRequest, _b = props.Emoji, Emoji = _b === void 0 ? DefaultEmoji__default['default'] : _b, _c = props.emojiData, emojiData = _c === void 0 ? defaultEmojiData : _c, _d = props.EmojiIndex, EmojiIndex = _d === void 0 ? DefaultEmojiIndex__default['default'] : _d, _e = props.EmojiPicker, EmojiPicker = _e === void 0 ? DefaultEmojiPicker__default['default'] : _e, _f = props.LoadingErrorIndicator, LoadingErrorIndicator$1 = _f === void 0 ? LoadingErrorIndicator : _f, _g = props.LoadingIndicator, LoadingIndicator$1 = _g === void 0 ? LoadingIndicator : _g, maxNumberOfFiles = props.maxNumberOfFiles, _h = props.Message, Message = _h === void 0 ? MessageSimple : _h, _j = props.multipleUploads, multipleUploads = _j === void 0 ? true : _j, onMentionsClick = props.onMentionsClick, onMentionsHover = props.onMentionsHover;
    var _k = useChatContext(), client = _k.client, mutes = _k.mutes, theme = _k.theme, useImageFlagEmojisOnWindows = _k.useImageFlagEmojisOnWindows;
    var t = useTranslationContext().t;
    ...
    var addNotification = function (text, type) {
        ...
        var id = uuid.v4();
        setNotifications(function (prevNotifications) { return __spreadArrays(prevNotifications, [{ id: id, text: text, type: type }]); });
    ...
    var doSendMessage = React.useCallback(function (message) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, doSendMessage(messagePreview)];
                    case 1:
                        _f.sent();
                        return [2 /*return*/];
                }
    ...
    var channelContextValue = __assign(__assign({}, state), { acceptedFiles: acceptedFiles,
        ...
        mutes: mutes,
        notifications: notifications, onMentionsClick: onMentionsHoverOrClick, onMentionsHover: onMentionsHoverOrClick, openThread: openThread,
        removeMessage: removeMessage,
        retrySendMessage: retrySendMessage,
        sendMessage: sendMessage,
        updateMessage: updateMessage, watcher_count: state.watcherCount });
    if (state.error) {
    ...
    return (React__default['default'].createElement("div", { className: "str-chat str-chat-channel " + theme + (useImageFlagEmojisOnWindows && navigator.platform.match(/Win/)
            ...
            : '') },
        React__default['default'].createElement(ChannelProvider, { value: channelContextValue },
...
var UnMemoizedChannelHeader = function (props) {
    ...
    var _b = useChannelContext(), channel = _b.channel, watcher_count = _b.watcher_count;
...
var UnMemoizedChatDown = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__down' },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__down-main' },
            React__default['default'].createElement("img", { "data-testid": 'chatdown-img', src: image || placeholder }),
 ...
 */
var ChannelListTeam = function (props) {
    var _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, children = props.children, _b = props.error, error = _b === void 0 ? false : _b, loading = props.loading, _c = props.LoadingErrorIndicator, LoadingErrorIndicator = _c === void 0 ? ChatDown : _c, _d = props.LoadingIndicator, LoadingIndicator = _d === void 0 ? LoadingChannels : _d, showSidebar = props.showSidebar, sidebarImage = props.sidebarImage;
    var client = useChatContext().client;
    var _e = client.user || {}, id = _e.id, image = _e.image, name = _e.name, status = _e.status;
    if (error) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__channel-list-team' },
        showSidebar && (React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__sidebar' },
            React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__sidebar--top' },
                React__default['default'].createElement(Avatar$1, { image: sidebarImage, size: 50 })))),
        React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__main' },
            React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__header' },
                React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__header--left' },
                    React__default['default'].createElement(Avatar$1, { image: image, name: name || id, size: 40 })),
                React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__header--middle' },
                    React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__header--title' }, name || id),
                    React__default['default'].createElement("div", { className: "str-chat__channel-list-team__header--status " + status }, status)),
                React__default['default'].createElement("div", { className: 'str-chat__channel-list-team__header--right' },
                    React__default['default'].createElement("button", { className: 'str-chat__channel-list-team__header--button' },
                        React__default['default'].createElement("img", { src: chevrondown })))),
            children)));
};
...
var useChannelTruncatedListener = function (setChannels, customHandler, forceUpdate) {
    ...
    React.useEffect(function () {
        var handleEvent = function (event) {
            setChannels(function (channels) { return __spreadArrays(channels); });
            if (customHandler && typeof customHandler === 'function') {
                customHandler(setChannels, event);
            }
            if (forceUpdate) {
...
var moveChannelUp = function (cid, channels) {
    // get channel index
        ...
        var handleEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        channel_1 = _a.sent();
                        setChannels(function (channels) { return uniqBy__default['default'](__spreadArrays([channel_1], channels), 'cid'); });
                        _a.label = 3;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        var handleEvent = function (event) {
            setChannels(function (channels) {
                ...
                if (!channelInList && allowNewMessagesFromUnfilteredChannels && event.channel_type) {
                    ...
                    return uniqBy__default['default'](__spreadArrays([channel], channels), 'cid');
                }
                if (!lockChannelOrder)
                    return moveChannelUp(event.cid || '', channels);
                return channels;
            });
        };
...
var useNotificationMessageNewListener = function (setChannels, customHandler) {
    var client = useChatContext().client;
    React.useEffect(function () {
        var handleEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
            var channel_1;
...
var UnMemoizedChannelPreviewCountOnly = function (props) {
    var channel = props.channel, displayTitle = props.displayTitle, setActiveChannel = props.setActiveChannel, unread = props.unread, watchers = props.watchers;
    return (React__default['default'].createElement("div", { className: unread && unread >= 1 ? 'unread' : '' },
        React__default['default'].createElement("button", { onClick: function () {
                if (setActiveChannel) {
            ...
            displayTitle,
            " ",
            React__default['default'].createElement("span", null, unread))));
};
var ChannelPreviewCountOnly = React__default['default'].memo(UnMemoizedChannelPreviewCountOnly);
...
var ChannelPreview = function (props) {
    var channel = props.channel, _a = props.Preview, Preview = _a === void 0 ? ChannelPreviewCountOnly : _a;
    ...
    if (!Preview)
        return null;
    return (React__default['default'].createElement(Preview, __assign({}, props, { active: isActive, displayImage: getDisplayImage(channel, client.user), displayTitle: getDisplayTitle(channel, client.user), lastMessage: lastMessage, latestMessage: getLatestMessagePreview(channel, t, userLanguage), setActiveChannel: setActiveChannel, unread: unread })));
};

var UnMemoizedChannelPreviewLastMessage = function (props) {
    var active = props.active, _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, channel = props.channel, displayImage = props.displayImage, displayTitle = props.displayTitle, latestMessage = props.latestMessage, _b = props.latestMessageLength, latestMessageLength = _b === void 0 ? 20 : _b, setActiveChannel = props.setActiveChannel, unread = props.unread, watchers = props.watchers;
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__channel-preview " + unreadClass + " " + activeClass },
        React__default['default'].createElement("button", { "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
            unread && unread >= 1 ? React__default['default'].createElement("div", { className: 'str-chat__channel-preview--dot' }) : null,
            React__default['default'].createElement(Avatar$1, { image: displayImage, name: displayTitle }),
            React__default['default'].createElement("div", { className: 'str-chat__channel-preview-info' },
                React__default['default'].createElement("span", { className: 'str-chat__channel-preview-title' }, displayTitle),
                React__default['default'].createElement("span", { className: 'str-chat__channel-preview-last-message' }, truncate(latestMessage, latestMessageLength)),
                unread && unread >= 1 ? (React__default['default'].createElement("span", { className: 'str-chat__channel-preview-unread-count' }, unread)) : null))));
};
/**
 * Used as preview component for channel item in [ChannelList](#channellist) component
 * @example ./ChannelPreviewLastMessage.md
 */
var ChannelPreviewLastMessage = React__default['default'].memo(UnMemoizedChannelPreviewLastMessage);
...
var UnMemoizedChannelList = function (props) {
    var _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, allowNewMessagesFromUnfilteredChannels = props.allowNewMessagesFromUnfilteredChannels, channelRenderFilterFn = props.channelRenderFilterFn, customActiveChannel = props.customActiveChannel, _b = props.EmptyStateIndicator, EmptyStateIndicator$1 = _b === void 0 ? EmptyStateIndicator : _b, filters = props.filters, _c = props.LoadingErrorIndicator, LoadingErrorIndicator = _c === void 0 ? ChatDown : _c, _d = props.LoadingIndicator, LoadingIndicator = _d === void 0 ? LoadingChannels : _d, _e = props.List, List = _e === void 0 ? ChannelListTeam : _e, lockChannelOrder = props.lockChannelOrder, onAddedToChannel = props.onAddedToChannel, onChannelDeleted = props.onChannelDeleted, onChannelHidden = props.onChannelHidden, onChannelTruncated = props.onChannelTruncated, onChannelUpdated = props.onChannelUpdated, onChannelVisible = props.onChannelVisible, onMessageNew = props.onMessageNew, onRemovedFromChannel = props.onRemovedFromChannel, options = props.options, _f = props.Paginator, Paginator = _f === void 0 ? LoadMorePaginator : _f, _g = props.Preview, Preview = _g === void 0 ? ChannelPreviewLastMessage : _g, _h = props.setActiveChannelOnMount, setActiveChannelOnMount = _h === void 0 ? true : _h, showSidebar = props.showSidebar, _j = props.sort, sort = _j === void 0 ? DEFAULT_SORT : _j, _k = props.watchers, watchers = _k === void 0 ? {} : _k;
    var _l = useChatContext(), channel = _l.channel, client = _l.client, closeMobileNav = _l.closeMobileNav, _m = _l.navOpen, navOpen = _m === void 0 ? false : _m, setActiveChannel = _l.setActiveChannel, theme = _l.theme, useImageFlagEmojisOnWindows = _l.useImageFlagEmojisOnWindows;
    var channelListRef = React.useRef(null);
    var _o = React.useState(0), channelUpdateCount = _o[0], setChannelUpdateCount = _o[1];
    /**
    ...
    var _p = usePaginatedChannels(client, filters || DEFAULT_FILTERS, sort || DEFAULT_SORT, options || DEFAULT_OPTIONS, activeChannelHandler), channels = _p.channels, hasNextPage = _p.hasNextPage, loadNextPage = _p.loadNextPage, setChannels = _p.setChannels, status = _p.status;
    ...
    var renderList = function () { return (React__default['default'].createElement(List, { Avatar: Avatar$1, error: status.error, loading: status.loadingChannels, LoadingErrorIndicator: LoadingErrorIndicator, LoadingIndicator: LoadingIndicator, showSidebar: showSidebar }, !loadedChannels || loadedChannels.length === 0 ? (React__default['default'].createElement(EmptyStateIndicator$1, { listType: 'channel' })) : (React__default['default'].createElement(Paginator, { hasNextPage: hasNextPage, loadNextPage: loadNextPage, refreshing: status.refreshing }, loadedChannels.map(renderChannel))))); };
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
...
var UnMemoizedChannelPreviewCompact = function (props) {
    var active = props.active, _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, channel = props.channel, displayImage = props.displayImage, displayTitle = props.displayTitle, setActiveChannel = props.setActiveChannel, unread = props.unread, watchers = props.watchers;
    var channelPreviewButton = React.useRef(null);
    ...
    return (React__default['default'].createElement("button", { className: "str-chat__channel-preview-compact " + unreadClass + " " + activeClass, "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
        React__default['default'].createElement("div", { className: 'str-chat__channel-preview-compact--left' },
            React__default['default'].createElement(Avatar$1, { image: displayImage, name: displayTitle, size: 20 })),
        React__default['default'].createElement("div", { className: 'str-chat__channel-preview-compact--right' }, displayTitle)));
};
/**
 *  Used as preview component for channel item in [ChannelList](#channellist) component.
 * @example ./ChannelPreviewCompact.md
 */
var ChannelPreviewCompact = React__default['default'].memo(UnMemoizedChannelPreviewCompact);

var UnMemoizedChannelPreviewMessenger = function (props) {
    var active = props.active, _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, channel = props.channel, displayImage = props.displayImage, displayTitle = props.displayTitle, latestMessage = props.latestMessage, _b = props.latestMessageLength, latestMessageLength = _b === void 0 ? 14 : _b, setActiveChannel = props.setActiveChannel, unread = props.unread, watchers = props.watchers;
    var channelPreviewButton = React.useRef(null);
    ...
    return (React__default['default'].createElement("button", { className: "str-chat__channel-preview-messenger " + unreadClass + " " + activeClass, "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
        React__default['default'].createElement("div", { className: 'str-chat__channel-preview-messenger--left' }, React__default['default'].createElement(Avatar$1, { image: displayImage, name: displayTitle, size: 40 })),
        React__default['default'].createElement("div", { className: 'str-chat__channel-preview-messenger--right' },
            ...
            React__default['default'].createElement("div", { className: 'str-chat__channel-preview-messenger--last-message' }, truncate(latestMessage, latestMessageLength)))));
};
/**
 * Used as preview component for channel item in [ChannelList](#channellist) component.
...
var UnMemoizedChannelSearch = function () { return (React__default['default'].createElement("div", { className: 'str-chat__channel-search' },
    React__default['default'].createElement("input", { placeholder: 'Search', type: 'text' }),
    React__default['default'].createElement("button", { type: 'submit' },
        React__default['default'].createElement("svg", { height: '17', viewBox: '0 0 18 17', width: '18', xmlns: 'http://www.w3.org/2000/svg' },
            React__default['default'].createElement("path", { d: 'M0 17.015l17.333-8.508L0 0v6.617l12.417 1.89L0 10.397z', fillRule: 'evenodd' }))))); };
var ChannelSearch = React__default['default'].memo(UnMemoizedChannelSearch);

var Cancel$6="Cancel";var Close$6="Close";var Delete$6="Delete";var Delivered$6="Delivered";var Flag$6="Flag";var Mute$6="Mute";var New$6="New";var Pin$6="Pin";var Send$6="Send";var Thread$7="Thread";var Unmute$6="Unmute";var Unpin$6="Unpin";var live$6="live";var enTranslations = {"1 reply":"1 reply","Attach files":"Attach files",Cancel:Cancel$6,"Channel Missing":"Channel Missing",Close:Close$6,"Close emoji picker":"Close emoji picker","Commands matching":"Commands matching","Connection failure, reconnecting now...":"Connection failure, reconnecting now...",Delete:Delete$6,Delivered:Delivered$6,"Edit Message":"Edit Message","Emoji matching":"Emoji matching","Empty message...":"Empty message...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Error adding flag: Either the flag already exist or there is issue with network connection ...","Error connecting to chat, refresh the page to try again.":"Error connecting to chat, refresh the page to try again.","Error muting a user ...":"Error muting a user ...","Error pinning message":"Error pinning message","Error removing message pin":"Error removing message pin","Error unmuting a user ...":"Error unmuting a user ...","Error · Unsent":"Error · Unsent","Error: {{ errorMessage }}":"Error: {{ errorMessage }}",Flag:Flag$6,"Message Failed · Click to try again":"Message Failed · Click to try again","Message Failed · Unauthorized":"Message Failed · Unauthorized","Message deleted":"Message deleted","Message has been successfully flagged":"Message has been successfully flagged","Message pinned":"Message pinned",Mute:Mute$6,New:New$6,"New Messages!":"New Messages!","Nothing yet...":"Nothing yet...","Only visible to you":"Only visible to you","Open emoji picker":"Open emoji picker","People matching":"People matching","Pick your emoji":"Pick your emoji",Pin:Pin$6,"Pinned by":"Pinned by",Send:Send$6,"Sending...":"Sending...","Start of a new thread":"Start of a new thread","This message was deleted...":"This message was deleted...",Thread:Thread$7,"Type your message":"Type your message",Unmute:Unmute$6,Unpin:Unpin$6,"You have no channels currently":"You have no channels currently","You've reached the maximum number of files":"You've reached the maximum number of files",live:live$6,"this content could not be displayed":"this content could not be displayed","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} and {{ lastUser }} are typing...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} and {{ moreCount }} more","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }}, and {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} and {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} and {{ secondUser }} are typing...","{{ imageCount }} more":"{{ imageCount }} more","{{ memberCount }} members":"{{ memberCount }} members","{{ replyCount }} replies":"{{ replyCount }} replies","{{ user }} has been muted":"{{ user }} has been muted","{{ user }} has been unmuted":"{{ user }} has been unmuted","{{ user }} is typing...":"{{ user }} is typing...","{{ watcherCount }} online":"{{ watcherCount }} online","🏙 Attachment...":"🏙 Attachment..."};

var Cancel$5="Annuleer";var Close$5="Sluit";var Delete$5="Verwijder";var Delivered$5="Afgeleverd";var Flag$5="Markeer";var Mute$5="Mute";var New$5="Nieuwe";var Pin$5="Pin";var Send$5="Verstuur";var Thread$6="Draadje";var Unmute$5="Unmute";var Unpin$5="Losmaken";var live$5="live";var nlTranslations = {"1 reply":"1 antwoord","Attach files":"Bijlage toevoegen",Cancel:Cancel$5,"Channel Missing":"Kanaal niet gevonden",Close:Close$5,"Close emoji picker":"Sluit de emoji-kiezer","Commands matching":"Bijpassende opdrachten","Connection failure, reconnecting now...":"Probleem met de verbinding, opnieuw verbinding maken...",Delete:Delete$5,Delivered:Delivered$5,"Edit Message":"Pas bericht aan","Emoji matching":"Emoji-overeenkomsten","Empty message...":"Leeg bericht...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Fout bij het markeren: of het bericht is al gemarkeerd of er is een probleem met de netwerk verbinding","Error connecting to chat, refresh the page to try again.":"Fout bij het verbinden, ververs de pagina om nogmaals te proberen","Error muting a user ...":"Fout bij het muten van de gebruiker","Error pinning message":"Fout bij vastzetten van bericht","Error removing message pin":"Fout bij verwijderen van berichtpin","Error unmuting a user ...":"Fout bij het unmuten van de gebruiker","Error · Unsent":"Error: · niet verzonden","Error: {{ errorMessage }}":"Error: {{ errorMessage }}",Flag:Flag$5,"Message Failed · Click to try again":"Bericht mislukt, klik om het nogmaals te proberen","Message Failed · Unauthorized":"Bericht mislukt, ongeautoriseerd","Message deleted":"Bericht verwijderd","Message has been successfully flagged":"Bericht is succesvol gemarkeerd","Message pinned":"Bericht vastgezet",Mute:Mute$5,New:New$5,"New Messages!":"Nieuwe Berichten!","Nothing yet...":"Nog niets ...","Only visible to you":"Alleen zichtbaar voor jou","Open emoji picker":"Open emojipicker","People matching":"Mensen die matchen","Pick your emoji":"Kies je emoji",Pin:Pin$5,"Pinned by":"Vastgemaakt door",Send:Send$5,"Sending...":"Aan het verzenden...","Start of a new thread":"Begin van een nieuwe draadje","This message was deleted...":"Dit bericht was verwijderd",Thread:Thread$6,"Type your message":"Type je bericht",Unmute:Unmute$5,Unpin:Unpin$5,"You have no channels currently":"Er zijn geen chats beschikbaar","You've reached the maximum number of files":"Je hebt het maximale aantal bestanden bereikt",live:live$5,"this content could not be displayed":"Deze inhoud kan niet weergegeven worden","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} en {{ lastUser }} zijn aan het typen ...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} en {{ moreCount }} meer","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} en {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} en {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} en {{ secondUser }} zijn aan het typen ...","{{ imageCount }} more":"+{{ imageCount }}","{{ memberCount }} members":"{{ memberCount }} deelnemers","{{ replyCount }} replies":"{{ replyCount }} antwoorden","{{ user }} has been muted":"{{ user }} is muted","{{ user }} has been unmuted":"{{ user }} is unmuted","{{ user }} is typing...":"{{ user }} is aan het typen...","{{ watcherCount }} online":"{{ watcherCount }} online","🏙 Attachment...":"🏙 Bijlage..."};

var Cancel$4="Отмена";var Close$4="Закрыть";var Delete$4="Удалить";var Delivered$4="Отправлено";var Flag$4="Пожаловаться";var Mute$4="Отключить уведомления";var New$4="Новые";var Pin$4="Штырь";var Send$4="Отправить";var Thread$5="Ветка";var Unmute$4="Включить уведомления";var Unpin$4="Открепить";var live$4="В прямом эфире";var ruTranslations = {"1 reply":"1 ответ","Attach files":"Прикрепить файлы",Cancel:Cancel$4,"Channel Missing":"Канал не найден",Close:Close$4,"Close emoji picker":"Закрыть окно выбора смайлов","Commands matching":"Соответствие команд","Connection failure, reconnecting now...":"Ошибка соединения, переподключение...",Delete:Delete$4,Delivered:Delivered$4,"Edit Message":"Редактировать сообщение","Emoji matching":"Соответствие эмодзи","Empty message...":"Пустое сообщение...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Ошибка добавления флага: флаг уже существует или ошибка подключения к сети...","Error connecting to chat, refresh the page to try again.":"Ошибка подключения к чату, обновите страницу чтобы попробовать снова.","Error muting a user ...":"Ошибка отключения уведомлений от пользователя...","Error pinning message":"Сообщение об ошибке при закреплении","Error removing message pin":"Ошибка при удалении булавки сообщения","Error unmuting a user ...":"Ошибка включения уведомлений...","Error · Unsent":"Ошибка · Не отправлено","Error: {{ errorMessage }}":"Ошибка: {{ errorMessage }}",Flag:Flag$4,"Message Failed · Click to try again":"Ошибка отправки сообщения · Нажмите чтобы повторить","Message Failed · Unauthorized":"Ошибка отправки сообщения · Неавторизованный","Message deleted":"Сообщение удалено","Message has been successfully flagged":"Жалоба на сообщение была принята","Message pinned":"Сообщение закреплено",Mute:Mute$4,New:New$4,"New Messages!":"Новые сообщения!","Nothing yet...":"Пока ничего нет...","Only visible to you":"Только видно для вас","Open emoji picker":"Выбрать emoji","People matching":"Соответствующие люди","Pick your emoji":"Выберите свой emoji",Pin:Pin$4,"Pinned by":"Закреплено",Send:Send$4,"Sending...":"Отправка...","Start of a new thread":"Начало новой ветки","This message was deleted...":"Сообщение было удалено...",Thread:Thread$5,"Type your message":"Ваше сообщение",Unmute:Unmute$4,Unpin:Unpin$4,"You have no channels currently":"У вас нет каналов в данный момент","You've reached the maximum number of files":"Вы достигли максимального количества файлов",live:live$4,"this content could not be displayed":"Этот контент не может быть отображен в данный момент","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} и {{ lastUser }} пишут...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} и {{ moreCount }} еще","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} и {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} и {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} и {{ secondUser }} пишут...","{{ imageCount }} more":"Ещё {{ imageCount }}","{{ memberCount }} members":"{{ memberCount }} члены","{{ replyCount }} replies":"{{ replyCount }} ответов","{{ user }} has been muted":"Вы отписались от уведомлений от {{ user }}","{{ user }} has been unmuted":"Уведомления от {{ user }} были включены","{{ user }} is typing...":"{{ user }} пишет...","{{ watcherCount }} online":"{{ watcherCount }} в сети","🏙 Attachment...":"🏙 Вложение..."};

var Cancel$3="İptal";var Close$3="Kapat";var Delete$3="Sil";var Delivered$3="İletildi";var Flag$3="Bayrak";var Mute$3="Sessiz";var New$3="Yeni";var Pin$3="Toplu iğne";var Send$3="Gönder";var Thread$4="Konu";var Unmute$3="Sesini aç";var Unpin$3="Sabitlemeyi kaldır";var live$3="canlı";var trTranslations = {"1 reply":"1 cevap","Attach files":"Dosya ekle",Cancel:Cancel$3,"Channel Missing":"Kanal bulunamıyor",Close:Close$3,"Close emoji picker":"Emoji seçiciyi kapat","Commands matching":"Eşleşen komutlar","Connection failure, reconnecting now...":"Bağlantı hatası, tekrar bağlanılıyor...",Delete:Delete$3,Delivered:Delivered$3,"Edit Message":"Mesajı Düzenle","Emoji matching":"Emoji eşleştirme","Empty message...":"Boş mesaj...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Bayraklama hatası: Bayrak zaten var veya bağlantı sorunlu","Error connecting to chat, refresh the page to try again.":"Bağlantı hatası, sayfayı yenileyip tekrar deneyin.","Error muting a user ...":"Kullanıcıyı sessize alırken hata oluştu ...","Error pinning message":"Mesaj sabitlenirken hata oluştu","Error removing message pin":"Mesaj PIN'i kaldırılırken hata oluştu","Error unmuting a user ...":"Kullanıcının sesini açarken hata oluştu ...","Error · Unsent":"Hata · Gönderilemedi","Error: {{ errorMessage }}":"Hata: {{ errorMessage }}",Flag:Flag$3,"Message Failed · Click to try again":"Mesaj Başarısız · Tekrar denemek için tıklayın","Message Failed · Unauthorized":"Mesaj Başarısız · Yetkisiz","Message deleted":"Mesaj silindi","Message has been successfully flagged":"Mesaj başarıyla bayraklandı","Message pinned":"Mesaj sabitlendi",Mute:Mute$3,New:New$3,"New Messages!":"Yeni Mesajlar!","Nothing yet...":"Şimdilik hiçbir şey...","Only visible to you":"Sadece size görünür","Open emoji picker":"Emoji klavyesini aç","People matching":"Eşleşen kişiler","Pick your emoji":"Emoji seçin",Pin:Pin$3,"Pinned by":"Sabitleyen",Send:Send$3,"Sending...":"Gönderiliyor...","Start of a new thread":"Yeni konunun başı","This message was deleted...":"Bu mesaj silindi",Thread:Thread$4,"Type your message":"Mesajınızı yazın",Unmute:Unmute$3,Unpin:Unpin$3,"You have no channels currently":"Henüz kanalınız yok","You've reached the maximum number of files":"Maksimum dosya sayısına ulaştınız",live:live$3,"this content could not be displayed":"bu içerik gösterilemiyor","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} ve {{ lastUser }} yazıyor...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} ve {{ moreCount }} daha","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }}, ve {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} ve {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} ve {{ secondUser }} yazıyor...","{{ imageCount }} more":"{{ imageCount }} adet daha","{{ memberCount }} members":"{{ memberCount }} üyeler","{{ replyCount }} replies":"{{ replyCount }} cevaplar","{{ user }} has been muted":"{{ user }} sessize alındı","{{ user }} has been unmuted":"{{ user }} sesi açıldı","{{ user }} is typing...":"{{ user }} yazıyor...","{{ watcherCount }} online":"{{ watcherCount }} çevrimiçi","🏙 Attachment...":"🏙 Ek..."};

var Cancel$2="Annuler";var Close$2="Fermer";var Delete$2="Supprimer";var Delivered$2="Publié";var Flag$2="Signaler";var Mute$2="Muet";var New$2="Nouveaux";var Pin$2="Épingle";var Send$2="Envoyer";var Thread$3="Fil de discussion";var Unmute$2="Désactiver muet";var Unpin$2="Détacher";var live$2="en direct";var frTranslations = {"1 reply":"1 réponse","Attach files":"Pièces jointes",Cancel:Cancel$2,"Channel Missing":"Canal Manquant",Close:Close$2,"Close emoji picker":"Fermer le sélecteur d'emojis","Commands matching":"Correspondance des commandes","Connection failure, reconnecting now...":"Échec de la connexion, reconnexion en cours...",Delete:Delete$2,Delivered:Delivered$2,"Edit Message":"Éditer un message","Emoji matching":"Correspondance emoji","Empty message...":"Message vide...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Erreur d'ajout du flag : le flag existe déjà ou vous rencontrez un problème de connexion au réseau ...","Error connecting to chat, refresh the page to try again.":"Erreur de connexion au chat, rafraîchissez la page pour réessayer.","Error muting a user ...":"Erreur de mise en sourdine d'un utilisateur ...","Error pinning message":"Erreur d'épinglage du message","Error removing message pin":"Erreur lors de la suppression du code PIN du message","Error unmuting a user ...":"Erreur de désactivation de la fonction sourdine pour un utilisateur ...","Error · Unsent":"Erreur - Non envoyé","Error: {{ errorMessage }}":"Erreur : {{ errorMessage }}",Flag:Flag$2,"Message Failed · Click to try again":"Échec de l'envoi du message - Cliquez pour réessayer","Message Failed · Unauthorized":"Échec de l'envoi du message - Non autorisé","Message deleted":"Message supprimé","Message has been successfully flagged":"Le message a été signalé avec succès","Message pinned":"Message épinglé",Mute:Mute$2,New:New$2,"New Messages!":"Nouveaux Messages!","Nothing yet...":"Aucun message...","Only visible to you":"Visible uniquement pour vous","Open emoji picker":"Ouvrez le sélecteur d'emoji","People matching":"Correspondance de personnes","Pick your emoji":"Choisissez votre emoji",Pin:Pin$2,"Pinned by":"Épinglé par",Send:Send$2,"Sending...":"Envoi en cours...","Start of a new thread":"Début d'un nouveau fil de discussion","This message was deleted...":"Ce message a été supprimé...",Thread:Thread$3,"Type your message":"Saisissez votre message",Unmute:Unmute$2,Unpin:Unpin$2,"You have no channels currently":"Vous n'avez actuellement aucun canal","You've reached the maximum number of files":"Vous avez atteint le nombre maximum de fichiers",live:live$2,"this content could not be displayed":"ce contenu n'a pu être affiché","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} et {{ lastUser }} sont en train d'écrire...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} et {{ moreCount }} autres","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} et {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} et {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} et {{ secondUser }} sont en train d'écrire...","{{ imageCount }} more":"{{ imageCount }} supplémentaires","{{ memberCount }} members":"{{ memberCount }} membres","{{ replyCount }} replies":"{{ replyCount }} réponses","{{ user }} has been muted":"{{ user }} a été mis en sourdine","{{ user }} has been unmuted":"{{ user }} n'est plus en sourdine","{{ user }} is typing...":"{{ user }} est en train d'écrire...","{{ watcherCount }} online":"{{ watcherCount }} en ligne","🏙 Attachment...":"🏙 Pièce jointe..."};

var Cancel$1="रद्द करें";var Close$1="बंद करे";var Delete$1="डिलीट";var Delivered$1="पहुंच गया";var Flag$1="फ्लैग करे";var Mute$1="म्यूट करे";var New$1="नए";var Pin$1="पिन";var Send$1="भेजे";var Thread$2="रिप्लाई थ्रेड";var Unmute$1="अनम्यूट";var Unpin$1="अनपिन";var live$1="लाइव";var hiTranslations = {"1 reply":"1 रिप्लाई","Attach files":"फाइल्स अटैच करे",Cancel:Cancel$1,"Channel Missing":"चैनल उपलब्ध नहीं है",Close:Close$1,"Close emoji picker":"इमोजी पिकर बंद करें","Commands matching":"मेल खाती है","Connection failure, reconnecting now...":"कनेक्शन विफल रहा, अब पुनः कनेक्ट हो रहा है ...",Delete:Delete$1,Delivered:Delivered$1,"Edit Message":"मैसेज में बदलाव करे","Emoji matching":"इमोजी मिलान","Empty message...":"खाली संदेश ...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"फ़ैल: या तो यह मैसेज के ऊपर पहले से फ्लैग है या तो आपके इंटरनेट कनेक्शन में कुछ परेशानी है","Error connecting to chat, refresh the page to try again.":"चैट से कनेक्ट करने में त्रुटि, पेज को रिफ्रेश करें","Error muting a user ...":"यूजर को म्यूट करने का प्रयास फेल हुआ","Error pinning message":"संदेश को पिन करने में त्रुटि","Error removing message pin":"संदेश पिन निकालने में त्रुटि","Error unmuting a user ...":"यूजर को अनम्यूट करने का प्रयास फेल हुआ","Error · Unsent":"फेल","Error: {{ errorMessage }}":"फेल: {{ errorMessage }}",Flag:Flag$1,"Message Failed · Click to try again":"मैसेज फ़ैल - पुनः कोशिश करें","Message Failed · Unauthorized":"मैसेज फ़ैल - अनधिकृत","Message deleted":"मैसेज हटा दिया गया","Message has been successfully flagged":"मैसेज को फ्लैग कर दिया गया है","Message pinned":"संदेश पिन किया गया",Mute:Mute$1,New:New$1,"New Messages!":"नए मैसेज!","Nothing yet...":"कोई मैसेज नहीं है","Only visible to you":"सिर्फ आपको दिखाई दे रहा है","Open emoji picker":"इमोजी पिकर खोलिये","People matching":"मेल खाते लोग","Pick your emoji":"इमोजी चूस करे",Pin:Pin$1,"Pinned by":"द्वारा पिन किया गया",Send:Send$1,"Sending...":"भेजा जा रहा है","Start of a new thread":"एक नए थ्रेड की शुरुआत","This message was deleted...":"मैसेज हटा दिया गया",Thread:Thread$2,"Type your message":"अपना मैसेज लिखे",Unmute:Unmute$1,Unpin:Unpin$1,"You have no channels currently":"आपके पास कोई चैनल नहीं है","You've reached the maximum number of files":"आप अधिकतम फ़ाइलों तक पहुँच गए हैं",live:live$1,"this content could not be displayed":"यह कॉन्टेंट लोड नहीं हो पाया","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} और {{ lastUser }} टाइप कर रहे हैं...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} और {{ moreCount }} और","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} और {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} और {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} और {{ secondUser }} टाइप कर रहे हैं...","{{ imageCount }} more":"{{ imageCount }} और","{{ memberCount }} members":"{{ memberCount }} मेंबर्स","{{ replyCount }} replies":"{{ replyCount }} रिप्लाई","{{ user }} has been muted":"{{ user }} को म्यूट कर दिया गया है","{{ user }} has been unmuted":"{{ user }} को अनम्यूट कर दिया गया है","{{ user }} is typing...":"{{ user }} टाइप कर रहा है...","{{ watcherCount }} online":"{{ watcherCount }} online","🏙 Attachment...":"🏙 अटैचमेंट"};

var Cancel="Annulla";var Close="Chiudi";var Delete="Cancella";var Delivered="Consegnato";var Flag="Segnala";var Mute="Silenzia";var New="Nuovo";var Pin="Pin";var Send="Invia";var Thread$1="Thread";var Unmute="Riattiva le notifiche";var Unpin="Sblocca";var live="live";var itTranslations = {"1 reply":"Una risposta","Attach files":"Allega file",Cancel:Cancel,"Channel Missing":"Il canale non esiste",Close:Close,"Close emoji picker":"Chiudi il selettore di emoji","Commands matching":"Comandi corrispondenti","Connection failure, reconnecting now...":"Connessione fallitta, riconnessione in corso...",Delete:Delete,Delivered:Delivered,"Edit Message":"Modifica messaggio","Emoji matching":"Abbinamento emoji","Empty message...":"Message vuoto...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Errore durante la segnalazione: la segnalazione esiste giá o c'é un problema di connessione ...","Error connecting to chat, refresh the page to try again.":"Errore di connessione alla chat, aggiorna la pagina per riprovare","Error muting a user ...":"Errore silenziando un utente ...","Error pinning message":"Errore durante il blocco del messaggio","Error removing message pin":"Errore durante la rimozione del PIN del messaggio","Error unmuting a user ...":"Errore riattivando le notifiche per l'utente ...","Error · Unsent":"Errore · Non inviato","Error: {{ errorMessage }}":"Errore: {{ errorMessage }}",Flag:Flag,"Message Failed · Click to try again":"Invio messaggio fallito · Clicca per riprovare","Message Failed · Unauthorized":"Invio messaggio fallito · Non autorizzato","Message deleted":"Messaggio cancellato","Message has been successfully flagged":"Il messaggio é stato segnalato con successo","Message pinned":"Messaggio bloccato",Mute:Mute,New:New,"New Messages!":"Nuovo messaggio!","Nothing yet...":"Ancora niente...","Only visible to you":"Visibile soltanto da te","Open emoji picker":"Apri il selettore dellle emoji","People matching":"Persone che corrispondono","Pick your emoji":"Scegli la tua emoji",Pin:Pin,"Pinned by":"Appuntato da",Send:Send,"Sending...":"Invio in corso...","Start of a new thread":"Inizia un nuovo thread","This message was deleted...":"Questo messaggio é stato cancellato",Thread:Thread$1,"Type your message":"Scrivi il tuo messaggio",Unmute:Unmute,Unpin:Unpin,"You have no channels currently":"Al momento non sono presenti canali","You've reached the maximum number of files":"Hai raggiunto il numero massimo di file",live:live,"this content could not be displayed":"questo contenuto non puó essere mostrato","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} e {{ lastUser }} stanno scrivendo...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} e altri {{ moreCount }}","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} e {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} e {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} e {{ secondUser }} stanno scrivendo...","{{ imageCount }} more":"+ {{ imageCount }}","{{ memberCount }} members":"{{ memberCount }} membri","{{ replyCount }} replies":"{{ replyCount }} risposte","{{ user }} has been muted":"{{ user }} é stato silenziato","{{ user }} has been unmuted":"Notifiche riattivate per {{ user }}","{{ user }} is typing...":"{{ user }} sta scrivendo...","{{ watcherCount }} online":"{{ watcherCount }} online","🏙 Attachment...":"🏙 Allegato..."};
...
var Streami18n = /** @class */ (function () {
    ...
    function Streami18n(options) {
        ...
        if (translationsForLanguage) {
            this.translations[this.currentLanguage] = (_h = {},
                _h[defaultNS] = translationsForLanguage,
                _h);
        }
...
var useChat = function (_a) {
    var _b;
    var client = _a.client, i18nInstance = _a.i18nInstance, initialNavOpen = _a.initialNavOpen;
    var _c = React.useState({
        t: function (key) { return key; },
        tDateTimeParser: function (input) { return Dayjs__default['default'](input); },
        userLanguage: 'en',
    }), translators = _c[0], setTranslators = _c[1];
    var _d = React.useState(), channel = _d[0], setChannel = _d[1];
    var _e = React.useState([]), mutes = _e[0], setMutes = _e[1];
    var _f = React.useState(initialNavOpen), navOpen = _f[0], setNavOpen = _f[1];
    ...
    React.useEffect(function () {
        var streami18n = i18nInstance instanceof Streami18n ? i18nInstance : new Streami18n({ language: 'en' });
        ...
        streami18n.getTranslators().then(function (translator) {
            var _a;
            if (translator) {
                setTranslators(__assign(__assign({}, translator), { userLanguage: ((_a = client === null || client === void 0 ? void 0 : client.user) === null || _a === void 0 ? void 0 : _a.language) || 'en' }));
            }
        });
    }, [client, i18nInstance]);
...
var Chat = function (props) {
    var children = props.children, client = props.client, i18nInstance = props.i18nInstance, _a = props.initialNavOpen, initialNavOpen = _a === void 0 ? true : _a, _b = props.theme, theme = _b === void 0 ? 'messaging light' : _b, _c = props.useImageFlagEmojisOnWindows, useImageFlagEmojisOnWindows = _c === void 0 ? false : _c;
    var _d = useChat({ client: client, i18nInstance: i18nInstance, initialNavOpen: initialNavOpen }), channel = _d.channel, closeMobileNav = _d.closeMobileNav, mutes = _d.mutes, navOpen = _d.navOpen, openMobileNav = _d.openMobileNav, setActiveChannel = _d.setActiveChannel, translators = _d.translators;
    if (!translators.t)
        return null;
...
var UnMemoizedEventComponent = function (props) {
    ...
    if (type === 'channel.event' &&
        ...
        return (React__default['default'].createElement("div", { className: 'str-chat__event-component__channel-event' },
            React__default['default'].createElement(Avatar$1, { image: (_c = event === null || event === void 0 ? void 0 : event.user) === null || _c === void 0 ? void 0 : _c.image, name: name_1 }),
            React__default['default'].createElement("div", { className: 'str-chat__event-component__channel-event__content' },
                ...
                React__default['default'].createElement("div", { className: 'str-chat__event-component__channel-event__date' }, dateFormatter(created_at, 'LT')))));
    }
    return null;
};
...
var InfiniteScrollPaginator = function (props) {
    var children = props.children, hasNextPage = props.hasNextPage, _a = props.LoadingIndicator, LoadingIndicator = _a === void 0 ? reactFileUtils.LoadingIndicator : _a, loadNextPage = props.loadNextPage, refreshing = props.refreshing, reverse = props.reverse, threshold = props.threshold;
    return (React__default['default'].createElement(InfiniteScroll, { hasMore: hasNextPage, isLoading: refreshing, isReverse: reverse, loader: React__default['default'].createElement("div", { className: 'str-chat__infinite-scroll-paginator', key: 'loadingindicator' },
            React__default['default'].createElement(LoadingIndicator, null)), loadMore: loadNextPage, threshold: threshold, useWindow: false }, children));
};

var ReverseInfiniteScroll = function (props) { return (React__default['default'].createElement(InfiniteScroll, __assign({}, props, { isReverse: true }))); };
...
var insertDates = function (messages, lastRead, userID, hideDeletedMessages, disableDateSeparator, hideNewMessageSeparator) {
    var _a, _b, _c;
    var unread = false;
    ...
    for (var i = 0, l = messages.length; i < l; i += 1) {
        ...
        if (!disableDateSeparator &&
            ...
            ((_c = newMessages === null || newMessages === void 0 ? void 0 : newMessages[newMessages.length - 1]) === null || _c === void 0 ? void 0 : _c.type) !== 'message.date' // do not show two date separators in a row
        ) {
            lastDateSeparator = messageDate;
            newMessages.push({
                date: message.created_at,
...
var getReadStates = function (messages, read) {
    if (read === void 0) { read = {}; }
...
var insertIntro = function (messages, headerPosition) {
    ...
    for (var i = 0, l = messages.length; i < l; i += 1) {
        ...
        var messageTime = message.created_at
            ...
            : null;
        var nextMessageTime = messages[i + 1] && messages[i + 1].created_at
            ? //@ts-expect-error
...
var UnMemoizedMessageListInner = function (props) {
    var bottomRef = props.bottomRef, channel = props.channel, client = props.client, DateSeparator = props.DateSeparator, _a = props.disableDateSeparator, disableDateSeparator = _a === void 0 ? false : _a, EmptyStateIndicator = props.EmptyStateIndicator, HeaderComponent = props.HeaderComponent, headerPosition = props.headerPosition, _b = props.hideDeletedMessages, hideDeletedMessages = _b === void 0 ? false : _b, _c = props.hideNewMessageSeparator, hideNewMessageSeparator = _c === void 0 ? false : _c, internalInfiniteScrollProps = props.internalInfiniteScrollProps, internalMessageProps = props.internalMessageProps, messages = props.messages, MessageSystem = props.MessageSystem, noGroupByUser = props.noGroupByUser, onMessageLoadCaptured = props.onMessageLoadCaptured, read = props.read, threadList = props.threadList, TypingIndicator = props.TypingIndicator;
    var lastRead = React.useMemo(function () { var _a; return (_a = channel.lastRead) === null || _a === void 0 ? void 0 : _a.call(channel); }, [channel]);
    var enrichMessages = function () {
        var messageWithDates = threadList
            ? messages
            : insertDates(messages, lastRead, client.userID, hideDeletedMessages, disableDateSeparator, hideNewMessageSeparator);
        if (HeaderComponent) {
        ...
        return enrichedMessages.map(function (message) {
            ...
            if (message.type === 'message.date' && message.date && isDate(message.date)) {
                return (React__default['default'].createElement("li", { key: message.date.toISOString() + "-i" },
                    React__default['default'].createElement(DateSeparator, { date: message.date, unread: message.unread })));
            }
            ...
            if (message.type !== 'message.read') {
                ...
                return (React__default['default'].createElement("li", { className: "str-chat__li str-chat__li--" + groupStyles, key: message.id || message.created_at, onLoadCapture: onMessageLoadCaptured },
                    React__default['default'].createElement(Message, __assign({ client: client, groupStyles: [groupStyles], lastReceivedId: lastReceivedId, message: message, readBy: readData[message.id] || [], threadList: threadList }, internalMessageProps))));
            }
            return null;
        });
    }, [
    ...
    if (!elements.length && EmptyStateIndicator) {
        return React__default['default'].createElement(EmptyStateIndicator, { listType: 'message' });
    }
    return (React__default['default'].createElement(InfiniteScroll, __assign({ className: 'str-chat__reverse-infinite-scroll', "data-testid": 'reverse-infinite-scroll', isReverse: true, useWindow: false }, internalInfiniteScrollProps),
        ...
        React__default['default'].createElement("div", { key: 'bottom', ref: bottomRef })));
};
var MessageListInner = React__default['default'].memo(UnMemoizedMessageListInner, isEqual__default['default']);
...
var UnMemoizedTypingIndicator = function (props) {
    var _a;
    var _b = props.Avatar, Avatar$1 = _b === void 0 ? Avatar : _b, _c = props.avatarSize, avatarSize = _c === void 0 ? 32 : _c, threadList = props.threadList;
    var _d = useChannelContext(), channel = _d.channel, thread = _d.thread, typing = _d.typing;
    var client = useChatContext().client;
    ...
    var typingInThread = Object.values(typing).some(function (event) { return (event === null || event === void 0 ? void 0 : event.parent_id) === (thread === null || thread === void 0 ? void 0 : thread.id); });
    return (React__default['default'].createElement("div", { className: "str-chat__typing-indicator " + ((threadList && typingInThread) || (!threadList && typingInChannel.length)
            ? 'str-chat__typing-indicator--typing'
            : '') },
        React__default['default'].createElement("div", { className: 'str-chat__typing-indicator__avatars' }, typingInChannel.map(function (_a, i) {
            var user = _a.user;
            return (React__default['default'].createElement(Avatar$1, { image: user === null || user === void 0 ? void 0 : user.image, key: (user === null || user === void 0 ? void 0 : user.id) + "-" + i, name: (user === null || user === void 0 ? void 0 : user.name) || (user === null || user === void 0 ? void 0 : user.id), size: avatarSize }));
        })),
...
var MessageListWithContext = /** @class */ (function (_super) {
    ...
    function MessageListWithContext(props) {
        ...
        _this.goToNewMessages = function () {
            ...
            _this.setState({ newMessagesNotification: false });
        };
        ...
        _this.bottomRef = React__default['default'].createRef();
        _this.messageList = React__default['default'].createRef();
        return _this;
    }
    ...
    MessageListWithContext.prototype.render = function () {
        var _a = this.props, addNotification = _a.addNotification, _b = _a.Attachment, Attachment$1 = _b === void 0 ? Attachment : _b, _c = _a.Avatar, Avatar$1 = _c === void 0 ? Avatar : _c, _d = _a.DateSeparator, DateSeparator$1 = _d === void 0 ? DateSeparator : _d, _e = _a.EmptyStateIndicator, EmptyStateIndicator$1 = _e === void 0 ? EmptyStateIndicator : _e, internalInfiniteScrollProps = _a.internalInfiniteScrollProps, _f = _a.LoadingIndicator, LoadingIndicator$1 = _f === void 0 ? LoadingIndicator : _f, _g = _a.Message, Message = _g === void 0 ? MessageSimple : _g, _h = _a.messageActions, messageActions = _h === void 0 ? Object.keys(MESSAGE_ACTIONS) : _h, _j = _a.messages, messages = _j === void 0 ? [] : _j, _k = _a.MessageSystem, MessageSystem = _k === void 0 ? EventComponent : _k, notifications = _a.notifications, _l = _a.noGroupByUser, noGroupByUser = _l === void 0 ? false : _l, _m = _a.pinPermissions, pinPermissions = _m === void 0 ? defaultPinPermissions : _m, t = _a.t, _o = _a.threadList, threadList = _o === void 0 ? false : _o, _p = _a.TypingIndicator, TypingIndicator$1 = _p === void 0 ? TypingIndicator : _p, _q = _a.unsafeHTML, unsafeHTML = _q === void 0 ? false : _q;
        return (React__default['default'].createElement(React__default['default'].Fragment, null,
            React__default['default'].createElement("div", { className: "str-chat__list " + (this.props.threadList ? 'str-chat__list--thread' : ''), ref: this.messageList },
                React__default['default'].createElement(MessageListInner, { bottomRef: this.bottomRef, channel: this.props.channel, client: this.props.client, DateSeparator: DateSeparator$1, disableDateSeparator: this.props.disableDateSeparator, EmptyStateIndicator: EmptyStateIndicator$1, HeaderComponent: this.props.HeaderComponent, headerPosition: this.props.headerPosition, hideDeletedMessages: this.props.hideDeletedMessages, hideNewMessageSeparator: this.props.hideNewMessageSeparator, internalInfiniteScrollProps: __assign({ hasMore: this.props.hasMore, isLoading: this.props.loadingMore, listenToScroll: this.listenToScroll, loader: (React__default['default'].createElement(Center, { key: 'loadingindicator' },
                            React__default['default'].createElement(LoadingIndicator$1, { size: 20 }))), loadMore: this.loadMore }, internalInfiniteScrollProps), internalMessageProps: {
                    ...
                    }, messages: messages, MessageSystem: MessageSystem, noGroupByUser: noGroupByUser, onMessageLoadCaptured: this.onMessageLoadCaptured, read: this.props.read, threadList: threadList, TypingIndicator: TypingIndicator$1 })),
            React__default['default'].createElement("div", { className: 'str-chat__list-notifications' },
                ...
                React__default['default'].createElement(MessageNotification, { onClick: this.goToNewMessages, showNotification: this.state.newMessagesNotification }, t('New Messages!')))));
    };
...
var MessageList = function (props) {
    var _a = useChannelContext(); _a.client; // eslint-disable-line
    _a.typing; // eslint-disable-line
    var channelContext = __rest(_a, ["client", "typing"]);
    var client = useChatContext().client;
    var translation = useTranslationContext();
    return React__default['default'].createElement(MessageListWithContext, __assign({ client: client }, channelContext, translation, props));
};
...
var VirtualizedMessageListWithContext = function (props) {
    var channel = props.channel, client = props.client, customMessageRenderer = props.customMessageRenderer, _a = props.disableDateSeparator, disableDateSeparator = _a === void 0 ? true : _a, _b = props.DateSeparator, DateSeparator$1 = _b === void 0 ? DateSeparator : _b, _c = props.EmptyStateIndicator, EmptyStateIndicator$1 = _c === void 0 ? EmptyStateIndicator : _c, hasMore = props.hasMore, _d = props.hideDeletedMessages, hideDeletedMessages = _d === void 0 ? false : _d, _e = props.hideNewMessageSeparator, hideNewMessageSeparator = _e === void 0 ? false : _e, _f = props.LoadingIndicator, LoadingIndicator$1 = _f === void 0 ? LoadingIndicator : _f, loadMore = props.loadMore, loadingMore = props.loadingMore, _g = props.Message, Message = _g === void 0 ? FixedHeightMessage : _g, _h = props.MessageDeleted, MessageDeleted$1 = _h === void 0 ? MessageDeleted : _h, _j = props.messageLimit, messageLimit = _j === void 0 ? 100 : _j, messages = props.messages, _k = props.MessageSystem, MessageSystem = _k === void 0 ? EventComponent : _k, _l = props.overscan, overscan = _l === void 0 ? 0 : _l, 
    // TODO: refactor to scrollSeekPlaceHolderConfiguration and components.ScrollSeekPlaceholder, like the Virtuoso Component
    scrollSeekPlaceHolder = props.scrollSeekPlaceHolder, _m = props.shouldGroupByUser, shouldGroupByUser = _m === void 0 ? false : _m, _o = props.stickToBottomScrollBehavior, stickToBottomScrollBehavior = _o === void 0 ? 'smooth' : _o, _p = props.TypingIndicator, TypingIndicator = _p === void 0 ? null : _p;
    var userID = client.userID;
    var lastRead = React.useMemo(function () { var _a; return (_a = channel.lastRead) === null || _a === void 0 ? void 0 : _a.call(channel); }, [channel]);
    var processedMessages = React.useMemo(function () {
        ...
        return disableDateSeparator
            ? messages
            : insertDates(messages, lastRead, userID, hideDeletedMessages, disableDateSeparator, hideNewMessageSeparator);
    }, [
        disableDateSeparator,
        hideDeletedMessages,
    ...
    var _q = useNewMessageNotification(processedMessages, client.userID), atBottom = _q.atBottom, newMessagesNotification = _q.newMessagesNotification, setNewMessagesNotification = _q.setNewMessagesNotification;
    ...
    var messageRenderer = React.useCallback(function (messageList, virtuosoIndex) {
        ...
        return (React__default['default'].createElement(Message, { groupedByUser: shouldGroupByUser &&
                streamMessageIndex > 0 &&
                ((_a = message.user) === null || _a === void 0 ? void 0 : _a.id) === ((_b = messageList[streamMessageIndex - 1].user) === null || _b === void 0 ? void 0 : _b.id), message: message }));
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__virtual-list' },
        React__default['default'].createElement(reactVirtuoso.Virtuoso, __assign({ atBottomStateChange: function (isAtBottom) {
        ...
        React__default['default'].createElement("div", { className: 'str-chat__list-notifications' },
            React__default['default'].createElement(MessageNotification, { onClick: function () {
                    if (virtuoso.current) {
                        virtuoso.current.scrollToIndex(processedMessages.length - 1);
                    }
                    setNewMessagesNotification(false);
                }, showNotification: newMessagesNotification }, t('New Messages!')))));
};
/**
...
function VirtualizedMessageList(props) {
    ...
    return (React__default['default'].createElement(VirtualizedMessageListWithContext, __assign({ channel: context.channel, client: context.client, hasMore: !!context.hasMore, loadingMore: !!context.loadingMore, 
        // @ts-expect-error
        ...
        messages: context.messages }, props)));
}
...
var Thread = function (props) {
    var _a, _b;
    var _c = useChannelContext(), channel = _c.channel, thread = _c.thread;
...
var DefaultThreadHeader = function (props) {
    var closeThread = props.closeThread, t = props.t, thread = props.thread;
    var getReplyCount = function () {
        if (!(thread === null || thread === void 0 ? void 0 : thread.reply_count) || !t)
            return '';
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__thread-header' },
        React__default['default'].createElement("div", { className: 'str-chat__thread-header-details' },
            React__default['default'].createElement("strong", null, t && t('Thread')),
            React__default['default'].createElement("small", null, getReplyCount())),
        React__default['default'].createElement("button", { className: 'str-chat__square-button', "data-testid": 'close-button', onClick: function (event) { return closeThread && closeThread(event); } },
            React__default['default'].createElement("svg", { height: '10', width: '10', xmlns: 'http://www.w3.org/2000/svg' },
                React__default['default'].createElement("path", { d: 'M9.916 1.027L8.973.084 5 4.058 1.027.084l-.943.943L4.058 5 .084 8.973l.943.943L5 5.942l3.973 3.974.943-.943L5.942 5z', fillRule: 'evenodd' })))));
};
var ThreadInner = function (props) {
    var additionalMessageInputProps = props.additionalMessageInputProps, additionalMessageListProps = props.additionalMessageListProps, additionalParentMessageProps = props.additionalParentMessageProps, _a = props.autoFocus, autoFocus = _a === void 0 ? true : _a, _b = props.fullWidth, fullWidth = _b === void 0 ? false : _b, PropMessage = props.Message, _c = props.MessageInput, ThreadMessageInput = _c === void 0 ? MessageInput : _c, _d = props.ThreadHeader, ThreadHeader = _d === void 0 ? DefaultThreadHeader : _d;
    var _e = useChannelContext(), channel = _e.channel, closeThread = _e.closeThread, loadMoreThread = _e.loadMoreThread, ContextMessage = _e.Message, thread = _e.thread, threadHasMore = _e.threadHasMore, threadLoadingMore = _e.threadLoadingMore, threadMessages = _e.threadMessages;
    var client = useChatContext().client;
    var t = useTranslationContext().t;
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__thread " + (fullWidth ? 'str-chat__thread--full' : '') },
        React__default['default'].createElement(ThreadHeader, { closeThread: closeThread, t: t, thread: thread }),
        React__default['default'].createElement("div", { className: 'str-chat__thread-list', ref: messageList },
            React__default['default'].createElement(Message, __assign({ channel: channel, client: client, initialMessage: true, message: thread, Message: ThreadMessage, threadList: true }, additionalParentMessageProps)),
            React__default['default'].createElement("div", { className: 'str-chat__thread-start' }, t('Start of a new thread')),
            React__default['default'].createElement(MessageList, __assign({ hasMore: threadHasMore, loadingMore: threadLoadingMore, loadMore: loadMoreThread, Message: ThreadMessage, messages: threadMessages || [], read: read, threadList: true }, additionalMessageListProps))),
        React__default['default'].createElement(ThreadMessageInput, __assign({ focus: autoFocus, Input: MessageInputSmall, parent: thread, publishTypingEvent: false }, additionalMessageInputProps))));
};

var UnMemoizedWindow = function (props) {
    var children = props.children, _a = props.hideOnThread, hideOnThread = _a === void 0 ? false : _a;
    var thread = useChannelContext().thread;
