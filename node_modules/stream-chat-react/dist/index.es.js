import React, { useState, useRef, useCallback, useEffect, useContext, useMemo, useReducer, useLayoutEffect, PureComponent } from 'react';
...
var UnMemoizedSafeAnchor = function (props) {
    ...
    return (React.createElement("a", { className: className, download: download, href: sanitized, rel: rel, target: target }, children));
};
...
var useTranslationContext = function () { return useContext(TranslationContext); };
...
var renderAttachmentActions = function (props) {
    ...
    return (React.createElement(AttachmentActions, __assign({}, attachment, { actionHandler: function (event, name, value) { return actionHandler === null || actionHandler === void 0 ? void 0 : actionHandler(name, value, event); }, actions: attachment.actions || [], id: attachment.id || '', key: "key-actions-" + attachment.id, text: attachment.text || '' })));
};
...
var ModalImage = function (props) {
    var data = props.data;
    return (React.createElement("div", { className: 'str-chat__modal-image__wrapper', "data-testid": 'modal-image' },
        React.createElement("img", { className: 'str-chat__modal-image__image', src: data.source })));
};
...
var ModalComponent = function (props) {
    ...
    return (React.createElement(ModalGateway, null, modalIsOpen ? (React.createElement(Modal$1, { onClose: toggleModal },
...
var UnMemoizedGallery = function (props) {
    ...
    return (React.createElement("div", { className: "str-chat__gallery " + (images.length > 3 ? 'str-chat__gallery--square' : '') },
        ...
        React.createElement(ModalComponent, { images: formattedArray, index: index, modalIsOpen: modalOpen, toggleModal: function () { return setModalOpen(!modalOpen); } })));
};
/**
...
var ImageComponent = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ModalComponent, { images: formattedArray, index: 0, modalIsOpen: modalIsOpen, toggleModal: toggleModal })));
};
...
var useChatContext = function () { return useContext(ChatContext); };
/**
...
var LoadingItems = function () { return (React.createElement("div", { className: 'str-chat__loading-channels-item' },
    React.createElement("div", { className: 'str-chat__loading-channels-avatar' }),
    React.createElement("div", { className: 'str-chat__loading-channels-meta' },
...
var LoadingErrorIndicator = React.memo(UnMemoizedLoadingErrorIndicator, function (prevProps, nextProps) { var _a, _b; return ((_a = prevProps.error) === null || _a === void 0 ? void 0 : _a.message) === ((_b = nextProps.error) === null || _b === void 0 ? void 0 : _b.message); });
...
var useChannelContext = function () { return useContext(ChannelContext); };
/**
...
var withChannelContext = function (Component) {
    var WithChannelContextComponent = function (props) {
        ...
        return React.createElement(Component, __assign({}, props, channelContext));
    };
...
var UnMemoizedMessageActionsBox = function (props) {
    ...
    var t = useTranslationContext().t;
    var _b = useState(false), reverse = _b[0], setReverse = _b[1];
    ...
    return (React.createElement("div", { className: "str-chat__message-actions-box\n        " + (open ? 'str-chat__message-actions-box--open' : '') + "\n        " + (mine ? 'str-chat__message-actions-box--mine' : '') + "\n        " + (reverse ? 'str-chat__message-actions-box--reverse' : '') + "\n      ", "data-testid": 'message-actions-box', ref: checkIfReverse },
        React.createElement("ul", { className: 'str-chat__message-actions-list' },
            messageActions.indexOf(MESSAGE_ACTIONS.pin) > -1 && !(message === null || message === void 0 ? void 0 : message.parent_id) && (React.createElement("button", { onClick: handlePin },
                React.createElement("li", { className: 'str-chat__message-actions-list-item' }, !(message === null || message === void 0 ? void 0 : message.pinned) ? t('Pin') : t('Unpin')))),
            ...
            messageActions.indexOf(MESSAGE_ACTIONS.mute) > -1 && (React.createElement("button", { onClick: handleMute },
                React.createElement("li", { className: 'str-chat__message-actions-list-item' }, isUserMuted && isUserMuted() ? t('Unmute') : t('Mute')))),
...
var MessageActions = function (props) {
    ...
    var _b = useState(false), actionsBoxOpen = _b[0], setActionsBoxOpen = _b[1];
...
var MML = function (props) {
    ...
    if (!source)
        return null;
    return (React.createElement(MML$1, { className: "mml-align-" + align, Loading: null, onSubmit: actionHandler, source: source, Success: null, theme: (theme || '').replace(' ', '-') }));
};
...
var UnMemoizedFixedHeightMessage = function (props) {
    ...
    var messageActionsHandler = useCallback(function () { return getMessageActions(['delete'], { canDelete: role.canDeleteMessage }); }, [role]);
    ...
    return (React.createElement("div", { className: "str-chat__virtual-message__wrapper " + (role.isMyMessage ? 'str-chat__virtual-message__wrapper--me' : '') + " " + (groupedByUser ? 'str-chat__virtual-message__wrapper--group' : ''), key: message.id },
        React.createElement(Avatar, { image: (_d = message.user) === null || _d === void 0 ? void 0 : _d.image, name: ((_e = message.user) === null || _e === void 0 ? void 0 : _e.name) || ((_f = message.user) === null || _f === void 0 ? void 0 : _f.id), shape: 'rounded', size: 38 }),
        React.createElement("div", { className: 'str-chat__virtual-message__content' },
            React.createElement("div", { className: 'str-chat__virtual-message__meta' },
                React.createElement("div", { className: 'str-chat__virtual-message__author', style: { color: userColor } },
                    React.createElement("strong", null, ((_g = message.user) === null || _g === void 0 ? void 0 : _g.name) || 'unknown'))),
            ...
            React.createElement("div", { className: 'str-chat__virtual-message__text', "data-testid": 'msg-text' },
                ...
                React.createElement("div", { className: 'str-chat__virtual-message__data' },
                    React.createElement(MessageActions, { customWrapperClass: 'str-chat__virtual-message__actions', getMessageActions: messageActionsHandler, message: message }),
...
var ReplyIcon = function () { return (React.createElement("svg", { height: '15', width: '18', xmlns: 'http://www.w3.org/2000/svg' },
...
var DeliveredCheckIcon = function () { return (React.createElement("svg", { height: '16', width: '16', xmlns: 'http://www.w3.org/2000/svg' },
...
var ReactionIcon = function () { return (React.createElement("svg", { height: '12', viewBox: '0 0 12 12', width: '12', xmlns: 'http://www.w3.org/2000/svg' },
...
var ThreadIcon = function () { return (React.createElement("svg", { height: '10', width: '14', xmlns: 'http://www.w3.org/2000/svg' },
...
var ErrorIcon = function () { return (React.createElement("svg", { height: '14', width: '14', xmlns: 'http://www.w3.org/2000/svg' },
...
var PinIcon = function () { return (React.createElement("svg", { height: '13', viewBox: '0 0 14 13', width: '14', xmlns: 'http://www.w3.org/2000/svg' },
...
var UnMemoizedMessageOptions = function (props) {
    ...
    if (isMyMessage && displayLeft) {
        return (React.createElement("div", { className: "str-chat__message-" + theme + "__actions", "data-testid": 'message-options-left' },
            displayActions && React.createElement(MessageActions, __assign({}, props, { messageWrapperRef: messageWrapperRef })),
            shouldShowReplies && (React.createElement("div", { className: "str-chat__message-" + theme + "__actions__action str-chat__message-" + theme + "__actions__action--thread", "data-testid": 'thread-action', onClick: propHandleOpenThread || handleOpenThread },
...
var UnMemoizedReactionSelector = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("div", { className: "str-chat__reaction-selector " + (reverse ? 'str-chat__reaction-selector--reverse' : ''), "data-testid": 'reaction-selector', ref: ref },
        ...
        React.createElement("ul", { className: 'str-chat__message-reactions-list' }, reactionOptions === null || reactionOptions === void 0 ? void 0 : reactionOptions.map(function (reactionOption) {
            var latestUser = getLatestUserForReactionType(reactionOption.id);
            var count = reaction_counts && reaction_counts[reactionOption.id];
            return (React.createElement("li", { className: 'str-chat__message-reactions-list-item', "data-text": reactionOption.id, key: "item-" + reactionOption.id, onClick: function (event) { return handleReaction && handleReaction(reactionOption.id, event); } },
                !!count && detailedView && (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: 'latest-user', onClick: hideTooltip, onMouseEnter: function (e) { return showTooltip(e, reactionOption.id); }, onMouseLeave: hideTooltip }, latestUser ? (React.createElement(Avatar$1, { image: latestUser.image, name: latestUser.name, size: 20 })) : (React.createElement("div", { className: 'latest-user-not-found' }))))),
                Emoji && (React.createElement(Emoji
                // @ts-expect-error
                , __assign({ 
                    // @ts-expect-error
...
var UnMemoizedReactionsList = function (props) {
    ...
    var emojiData = useMemo(function () { return getStrippedEmojiData(fullEmojiData); }, [fullEmojiData]);
    var reactionOptions = reactionOptionsProp || defaultMinimalEmojis || [];
    ...
    return (React.createElement("div", { className: "str-chat__reaction-list " + (reverse ? 'str-chat__reaction-list--reverse' : ''), "data-testid": 'reaction-list', onClick: onClick },
        React.createElement("ul", null,
            getReactionTypes().map(function (reactionType) {
                var emojiDefinition = getOptionForType(reactionType);
                return emojiDefinition ? (React.createElement("li", { key: emojiDefinition.id },
                    Emoji && (React.createElement(Emoji
                    // @ts-expect-error
                    , __assign({ 
                        // @ts-expect-error
...
var UnMemoizedSimpleReactionsList = function (props) {
    ...
    return (React.createElement("ul", { className: 'str-chat__simple-reactions-list', "data-testid": 'simple-reaction-list', onMouseLeave: function () { return setTooltipReactionType(undefined); } },
        getReactionTypes().map(function (reactionType, i) {
            var _a, _b;
            var emojiDefinition = getOptionForType(reactionType);
            return emojiDefinition ? (React.createElement("li", { className: 'str-chat__simple-reactions-list-item', key: (emojiDefinition === null || emojiDefinition === void 0 ? void 0 : emojiDefinition.id) + "-" + i, onClick: function (event) { return handleReaction(reactionType, event); } },
                React.createElement("span", { onMouseEnter: function () { return setTooltipReactionType(reactionType); } },
                    ...
                    "\u00A0"),
                tooltipReactionType === ((_a = getOptionForType(reactionType)) === null || _a === void 0 ? void 0 : _a.id) && (React.createElement("div", { className: 'str-chat__simple-reactions-list-tooltip' },
                    React.createElement("div", { className: 'arrow' }), (_b = getUsersPerReactionType(tooltipReactionType)) === null || _b === void 0 ? void 0 :
                    _b.join(', '))))) : null;
        }),
        (reactions === null || reactions === void 0 ? void 0 : reactions.length) !== 0 && (React.createElement("li", { className: 'str-chat__simple-reactions-list-item--last-number' }, getTotalReactionCount()))));
};
...
var UnMemoizedMessageTextComponent = function (props) {
    ...
    var messageText = useMemo(function () { return renderText$1(messageTextToRender, message.mentioned_users); }, [
        message.mentioned_users,
        messageTextToRender,
    ]);
    ...
    return (React.createElement("div", { className: wrapperClass },
        React.createElement("div", { className: ("\n          " + innerClass + "\n          " + (hasAttachment ? " str-chat__message-" + theme + "-text-inner--has-attachment" : '') + "\n          " + (isOnlyEmojis(message.text) ? " str-chat__message-" + theme + "-text-inner--is-emoji" : '') + "\n        ").trim(), "data-testid": 'message-text-inner-wrapper', onClick: onMentionsClick, onMouseOver: onMentionsHover },
            ...
            hasReactions && !showDetailedReactions && isReactionEnabled && (React.createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions, reverse: true })),
            showDetailedReactions && isReactionEnabled && (React.createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef }))),
        React.createElement(MessageOptions, __assign({}, props, customOptionProps, { onReactionListClick: onReactionListClick }))));
};
...
var EmojiPicker = function (props) {
    ...
    if (emojiPickerIsOpen && emojiData) {
        ...
        return (React.createElement("div", { className: className, ref: emojiPickerRef }, Picker && (React.createElement(Picker, { color: '#006CFF', data: emojiData, emoji: 'point_up', emojisToShowFilter: filterEmoji, native: true, onSelect: onSelectEmoji, set: 'facebook', showPreview: false, showSkinTones: false, title: t('Pick your emoji'), useButton: true }))));
    }
    return null;
};
...
var useMessageInput = function (props) {
    ...
    var _d = useReducer(messageInputReducer, message, initState), state = _d[0], dispatch = _d[1];
    ...
    // Commands / mentions
    var getCommands = useCallback(function () { var _a, _b; return (_b = (_a = channel === null || channel === void 0 ? void 0 : channel.getConfig) === null || _a === void 0 ? void 0 : _a.call(channel)) === null || _b === void 0 ? void 0 : _b.commands; }, [channel]);
    ...
    var maxFilesAllowed = useMemo(function () { return (!multipleUploads ? 1 : maxNumberOfFiles || apiMaxNumberOfFiles); }, [maxNumberOfFiles, multipleUploads]);
...
var UploadsPreview = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        imageOrder.length > 0 && (React.createElement(ImagePreviewer, { disabled: channelContext.maxNumberOfFiles !== undefined &&
...
var UnMemoizedUserItem = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__user-item' },
        React.createElement(Avatar$1, { image: entity.image, size: 20 }),
...
var UnMemoizedChatAutoComplete = function (props) {
    ...
    var queryMembersDebounced = useCallback(debounce(function (query, onReady) { return __awaiter(void 0, void 0, void 0, function () {
...
var EditMessageForm = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__edit-message-form' },
        React.createElement(ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React.createElement("form", { onSubmit: messageInput.handleSubmit },
                messageInput.isUploadEnabled && React.createElement(UploadsPreview, __assign({}, messageInput)),
                React.createElement(EmojiPicker, __assign({}, messageInput, { small: true })),
                React.createElement(ChatAutoComplete, { additionalTextareaProps: additionalTextareaProps, commands: messageInput.getCommands(), grow: grow, handleSubmit: messageInput.handleSubmit, innerRef: messageInput.textareaRef, maxRows: maxRows, mentionAllAppUsers: mentionAllAppUsers, mentionQueryParams: mentionQueryParams, onChange: messageInput.handleChange, onPaste: messageInput.onPaste, onSelectItem: messageInput.onSelectItem, placeholder: t('Type your message'), rows: 1, value: messageInput.text }),
                React.createElement("div", { className: 'str-chat__message-team-form-footer' },
                    React.createElement("div", { className: 'str-chat__edit-message-form-options' },
                        React.createElement("span", { className: 'str-chat__input-emojiselect', onClick: messageInput.openEmojiPicker },
                            React.createElement(EmojiIcon, null)),
                        messageInput.isUploadEnabled && (React.createElement("div", { className: 'str-chat__fileupload-wrapper', "data-testid": 'fileinput' },
                            React.createElement(Tooltip, null, messageInput.maxFilesLeft
                                ? t('Attach files')
                                : t("You've reached the maximum number of files")),
                            React.createElement(FileUploadButton, { accepts: channelContext.acceptedFiles, disabled: messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, multiple: channelContext.multipleUploads },
                                React.createElement("span", { className: 'str-chat__input-fileupload' },
                                    React.createElement(FileUploadIcon$1, null)))))),
...
var MessageInputLarge = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__input-large' },
        React.createElement(ImageDropzone, { accept: acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: multipleUploads },
            React.createElement("div", { className: 'str-chat__input' },
                React.createElement("div", { className: 'str-chat__input--textarea-wrapper' },
                    messageInput.isUploadEnabled && React.createElement(UploadsPreview, __assign({}, messageInput)),
                    React.createElement(ChatAutoComplete, { additionalTextareaProps: additionalTextareaProps, commands: messageInput.getCommands(), disabled: disabled, disableMentions: disableMentions, grow: grow, handleSubmit: messageInput.handleSubmit, innerRef: messageInput.textareaRef, maxRows: maxRows, mentionAllAppUsers: mentionAllAppUsers, mentionQueryParams: mentionQueryParams, onChange: messageInput.handleChange, onPaste: messageInput.onPaste, onSelectItem: messageInput.onSelectItem, placeholder: t('Type your message'), rows: 1, SuggestionItem: SuggestionItem, SuggestionList: SuggestionList, triggers: autocompleteTriggers, value: messageInput.text }),
                    messageInput.isUploadEnabled && (React.createElement("div", { className: 'str-chat__fileupload-wrapper', "data-testid": 'fileinput' },
                        React.createElement(Tooltip, null, messageInput.maxFilesLeft
                            ? t('Attach files')
                            : t("You've reached the maximum number of files")),
                        React.createElement(FileUploadButton, { accepts: acceptedFiles, disabled: messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, multiple: multipleUploads },
                            React.createElement("span", { className: 'str-chat__input-fileupload' },
                                React.createElement(FileUploadIcon$1, null))))),
                    React.createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React.createElement(Tooltip, null, messageInput.emojiPickerIsOpen ? t('Close emoji picker') : t('Open emoji picker')),
                        React.createElement("span", { className: 'str-chat__input-emojiselect', onClick: messageInput.emojiPickerIsOpen
                            ...
                            React.createElement(EmojiIcon, null))),
                    React.createElement(EmojiPicker, __assign({}, messageInput))),
                React.createElement(SendButton$1, { sendMessage: messageInput.handleSubmit })),
            React.createElement("div", null,
...
var UnMemoizedMessageInput = function (props) {
    ...
    return (React.createElement(Input, __assign({}, props, { additionalTextareaProps: additionalTextareaProps, disabled: disabled, focus: focus, grow: grow, maxRows: maxRows, publishTypingEvent: publishTypingEvent })));
};
/**
...
var MessageInputFlat = function (props) {
    ...
    var messageInput = useMessageInput(__assign(__assign({}, props), { additionalTextareaProps: additionalTextareaProps,
        ...
        maxRows: maxRows,
        publishTypingEvent: publishTypingEvent }));
    return (React.createElement("div", { className: "str-chat__input-flat " + (SendButton$1 ? 'str-chat__input-flat--send-button-active' : null) },
        React.createElement(ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React.createElement("div", { className: 'str-chat__input-flat-wrapper' },
                React.createElement("div", { className: 'str-chat__input-flat--textarea-wrapper' },
                    ...
                    React.createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React.createElement(Tooltip, null, messageInput.emojiPickerIsOpen ? t('Close emoji picker') : t('Open emoji picker')),
                        React.createElement("span", { className: 'str-chat__input-flat-emojiselect', onClick: messageInput.emojiPickerIsOpen
                                ? messageInput.closeEmojiPicker
                ...
                SendButton$1 && React.createElement(SendButton$1, { sendMessage: messageInput.handleSubmit })))));
};
...
var MessageInputSmall = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__small-message-input__wrapper' },
        React.createElement(ImageDropzone, { accept: channelContext.acceptedFiles, disabled: !messageInput.isUploadEnabled || messageInput.maxFilesLeft === 0, handleFiles: messageInput.uploadNewFiles, maxNumberOfFiles: messageInput.maxFilesLeft, multiple: channelContext.multipleUploads },
            React.createElement("div", { className: "str-chat__small-message-input " + (SendButton$1 ? 'str-chat__small-message-input--send-button-active' : null) },
                React.createElement("div", { className: 'str-chat__small-message-input--textarea-wrapper' },
                    ...
                    React.createElement("div", { className: 'str-chat__emojiselect-wrapper' },
                        React.createElement(Tooltip, null, messageInput.emojiPickerIsOpen ? t('Close emoji picker') : t('Open emoji picker')),
                        React.createElement("span", { className: 'str-chat__small-message-input-emojiselect', onClick: messageInput.emojiPickerIsOpen
                                ? messageInput.closeEmojiPicker
                                : messageInput.openEmojiPicker, onKeyDown: messageInput.handleEmojiKeyDown, role: 'button', tabIndex: 0 },
                            React.createElement(EmojiIcon, null))),
                    React.createElement(EmojiPicker, __assign({}, messageInput, { small: true }))),
...
var MessageSimpleWithContext = function (props) {
    ...
    if (message.deleted_at) {
        return React.createElement(MessageDeleted$1, { message: message });
    }
    return (React.createElement(React.Fragment, null,
        ...
        message && (React.createElement("div", { className: ("\n\t\t\t\t\t\t" + messageClasses + "\n\t\t\t\t\t\tstr-chat__message--" + message.type + "\n\t\t\t\t\t\tstr-chat__message--" + message.status + "\n\t\t\t\t\t\t" + (message.text ? 'str-chat__message--has-text' : 'has-no-text') + "\n\t\t\t\t\t\t" + (hasAttachment ? 'str-chat__message--has-attachment' : '') + "\n            " + (hasReactions && isReactionEnabled ? 'str-chat__message--with-reactions' : '') + "\n            " + (message.pinned ? 'pinned-message' : '') + "\n\t\t\t\t\t").trim(), key: message.id || '', ref: messageWrapperRef },
            React.createElement(MessageSimpleStatus, __assign({}, props)),
            message.user && (React.createElement(Avatar$1, { image: message.user.image, name: message.user.name || message.user.id, onClick: onUserClick, onMouseOver: onUserHover })),
            React.createElement("div", { className: 'str-chat__message-inner', "data-testid": 'message-inner', onClick: message.status === 'failed' && message.errorStatusCode !== 403
                    ...
                    : undefined },
                !message.text && (React.createElement(React.Fragment, null,
                    React.createElement(MessageOptions, __assign({}, props, { handleOpenThread: handleOpenThread, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick })),
                    hasReactions && !showDetailedReactions && isReactionEnabled && (React.createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions, reverse: true })),
                    showDetailedReactions && isReactionEnabled && (React.createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef })))),
                message.attachments && Attachment && (React.createElement(Attachment, { actionHandler: handleAction, attachments: message.attachments })),
                message.text && (React.createElement(MessageText, __assign({}, props, { customOptionProps: {
                ...
                !threadList && message.reply_count !== 0 && (React.createElement("div", { className: 'str-chat__message-simple-reply-button' },
                ...
                React.createElement("div", { className: "str-chat__message-data str-chat__message-simple-data" },
                    ...
                    React.createElement(MessageTimestamp, { calendar: true, customClass: 'str-chat__message-simple-timestamp', formatDate: formatDate, message: message })))))));
};
var MessageSimpleStatus = function (_a) {
    ...
    if (message && message.status === 'sending') {
        return (React.createElement("span", { className: 'str-chat__message-simple-status', "data-testid": 'message-status-sending' },
    ...
    if (readBy && readBy.length !== 0 && !threadList && !justReadByMe) {
        ...
        return (React.createElement("span", { className: 'str-chat__message-simple-status', "data-testid": 'message-status-read-by' },
            React.createElement(Tooltip, null, readBy && getReadByTooltipText(readBy, t, client)),
            React.createElement(Avatar$1, { image: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.image, name: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.name, size: 15 }),
            readBy.length > 2 && (React.createElement("span", { className: 'str-chat__message-simple-status-number', "data-testid": 'message-status-read-by-many' }, readBy.length - 1))));
    }
    if (message && message.status === 'received' && message.id === lastReceivedId && !threadList) {
        return (React.createElement("span", { className: 'str-chat__message-simple-status', "data-testid": 'message-status-received' },
...
var MessageSimple = function (props) {
    ...
    return (React.createElement(MemoizedMessageSimple, __assign({}, props, { Attachment: Attachment$1, isReactionEnabled: isReactionEnabled, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};
...
var MessageCommerceWithContext = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: ("\n\t\t\t\t\t\t" + messageClasses + "\n\t\t\t\t\t\tstr-chat__message-commerce--" + message.type + "\n\t\t\t\t\t\t" + (message.text ? 'str-chat__message-commerce--has-text' : 'str-chat__message-commerce--has-no-text') + "\n\t\t\t\t\t\t" + (hasAttachment ? 'str-chat__message-commerce--has-attachment' : '') + "\n            " + (hasReactions && isReactionEnabled ? 'str-chat__message-commerce--with-reactions' : '') + "\n            " + ("str-chat__message-commerce--" + firstGroupStyle) + "\n            " + (message.pinned ? 'pinned-message' : '') + "\n\t\t\t\t\t").trim(), "data-testid": 'message-commerce-wrapper', key: message.id },
            (firstGroupStyle === 'bottom' || firstGroupStyle === 'single') && (React.createElement(Avatar$1, { image: (_a = message.user) === null || _a === void 0 ? void 0 : _a.image, name: ((_b = message.user) === null || _b === void 0 ? void 0 : _b.name) || ((_c = message.user) === null || _c === void 0 ? void 0 : _c.id), onClick: onUserClick, onMouseOver: onUserHover, size: 32 })),
            React.createElement("div", { className: 'str-chat__message-commerce-inner' },
                message && !message.text && (React.createElement(React.Fragment, null,
                    React.createElement(MessageOptions, __assign({}, props, { displayActions: false, displayLeft: false, displayReplies: false, onReactionListClick: onReactionListClick, theme: 'commerce' })),
                    hasReactions && !showDetailedReactions && isReactionEnabled && (React.createElement(ReactionsList$1, { onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
                    showDetailedReactions && isReactionEnabled && (React.createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef, reverse: false })))),
                message.attachments && (React.createElement(Attachment$1, { actionHandler: handleAction, attachments: message.attachments })),
                message.mml && (React.createElement(MML, { actionHandler: handleAction, align: isMyMessage() ? 'right' : 'left', source: message.mml })),
                message.text && (React.createElement(MessageText, __assign({}, props, { customInnerClass: 'str-chat__message-commerce-text-inner', customOptionProps: {
                ...
                React.createElement("div", { className: 'str-chat__message-commerce-data' },
                    !isMyMessage() ? (React.createElement("span", { className: 'str-chat__message-commerce-name' }, ((_d = message.user) === null || _d === void 0 ? void 0 : _d.name) || ((_e = message.user) === null || _e === void 0 ? void 0 : _e.id))) : null,
                    React.createElement(MessageTimestamp, { customClass: 'str-chat__message-commerce-timestamp', format: 'LT', formatDate: formatDate, message: message }))))));
};
...
var MessageCommerce = function (props) {
    ...
    var reactionSelectorRef = useRef(null);
    var _a = useReactionClick(message, reactionSelectorRef), isReactionEnabled = _a.isReactionEnabled, onReactionListClick = _a.onReactionListClick, showDetailedReactions = _a.showDetailedReactions;
    return (React.createElement(MemoizedMessageCommerce, __assign({}, props, { isReactionEnabled: isReactionEnabled, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};
...
var MessageLivestreamWithContext = function (props) {
    ...
    if (editing) {
        return (React.createElement("div", { className: "str-chat__message-team str-chat__message-team--" + firstGroupStyle + " str-chat__message-team--editing", "data-testid": 'message-livestream-edit' },
            (firstGroupStyle === 'top' || firstGroupStyle === 'single') && (React.createElement("div", { className: 'str-chat__message-team-meta' },
                React.createElement(Avatar$1, { image: (_b = message.user) === null || _b === void 0 ? void 0 : _b.image, name: ((_c = message.user) === null || _c === void 0 ? void 0 : _c.name) || ((_d = message.user) === null || _d === void 0 ? void 0 : _d.id), onClick: onUserClick, onMouseOver: onUserHover, size: 40 }))),
    ...
    return (React.createElement(React.Fragment, null,
        message.pinned && (React.createElement("div", { className: 'str-chat__message-livestream-pin-indicator' },
            React.createElement(PinIndicator$1, { message: message, t: t }))),
                    ...
                    React.createElement("div", { className: isOnlyEmojis(message.text) ? 'str-chat__message-livestream-text--is-emoji' : '', "data-testid": 'message-livestream-text', onClick: onMentionsClickMessage, onMouseOver: onMentionsHoverMessage },
                        ...
                        message.status === 'failed' && (React.createElement("p", { onClick: message.errorStatusCode !== 403 ? function () { return handleRetry(message); } : undefined },
                            ...
                            message.errorStatusCode !== 403
                                ? t('Message Failed · Click to try again')
                                : t('Message Failed · Unauthorized')))),
                    message.attachments && Attachment$1 && (React.createElement(Attachment$1, { actionHandler: handleAction, attachments: message.attachments })),
                    isReactionEnabled && (React.createElement(ReactionsList, { handleReaction: handleReaction, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
...
var MessageLivestreamActions = function (props) {
    ...
    var _a = useState(false), actionsBoxOpen = _a[0], setActionsBoxOpen = _a[1];
    var hideOptions = useCallback(function () { return setActionsBoxOpen(false); }, []);
    ...
    return (React.createElement("div", { className: "str-chat__message-livestream-actions", "data-testid": 'message-livestream-actions' },
        React.createElement(MessageTimestamp, { customClass: 'str-chat__message-livestream-time', formatDate: formatDate, message: message }),
        (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.reactions) && (React.createElement("span", { "data-testid": 'message-livestream-reactions-action', onClick: onReactionListClick },
            React.createElement("span", null,
                React.createElement(ReactionIcon, null)))),
        !threadList && (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.replies) && (React.createElement("span", { "data-testid": 'message-livestream-thread-action', onClick: handleOpenThread },
            React.createElement(ThreadIcon, null))),
        showActionsBox && (React.createElement(MessageActions, __assign({}, props, { customWrapperClass: '', getMessageActions: getMessageActions, inline: true })))));
};
...
var MessageTeamWithContext = function (props) {
    ...
    var messageText = useMemo(function () { return renderText$1(messageTextToRender, messageMentionedUsersItem); }, [
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "str-chat__message-team str-chat__message-team--" + firstGroupStyle + " str-chat__message-team--" + message.type + " " + (threadList ? 'thread-list' : '') + " str-chat__message-team--" + message.status + " " + (message.pinned ? 'pinned-message' : ''), "data-testid": 'message-team', ref: messageWrapperRef },
            React.createElement("div", { className: 'str-chat__message-team-meta' },
                firstGroupStyle === 'top' || firstGroupStyle === 'single' || initialMessage ? (React.createElement(Avatar$1, { image: (_e = message.user) === null || _e === void 0 ? void 0 : _e.image, name: ((_f = message.user) === null || _f === void 0 ? void 0 : _f.name) || ((_g = message.user) === null || _g === void 0 ? void 0 : _g.id), onClick: onUserClick, onMouseOver: onUserHover, size: 40 })) : (React.createElement("div", { "data-testid": 'team-meta-spacer', style: { marginRight: 0, width: 40 } })),
                React.createElement(MessageTimestamp, { formatDate: formatDate, message: message })),
            React.createElement("div", { className: 'str-chat__message-team-group' },
                ...
                React.createElement("div", { className: "str-chat__message-team-content str-chat__message-team-content--" + firstGroupStyle + " str-chat__message-team-content--" + (message.text === '' ? 'image' : 'text'), "data-testid": 'message-team-content' },
                    !initialMessage &&
                        ...
                        message && showDetailedReactions && (React.createElement(ReactionSelector$1, { detailedView: true, handleReaction: handleReaction, latest_reactions: message.latest_reactions, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, ref: reactionSelectorRef })),
                        isReactionEnabled && (React.createElement("span", { "data-testid": 'message-team-reaction-icon', onClick: onReactionListClick, title: 'Reactions' },
                            React.createElement(ReactionIcon, null))),
                        !threadList && (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.replies) !== false && (React.createElement("span", { "data-testid": 'message-team-thread-icon', onClick: handleOpenThread, title: 'Start a thread' },
                            React.createElement(ThreadIcon, null))),
                        showActionsBox && (React.createElement(MessageActions, { addNotification: addNotification, customWrapperClass: '', getFlagMessageErrorNotification: getFlagMessageErrorNotification, getFlagMessageSuccessNotification: getFlagMessageSuccessNotification, getMessageActions: getMessageActions, getMuteUserErrorNotification: getMuteUserErrorNotification, getMuteUserSuccessNotification: getMuteUserSuccessNotification, handleDelete: handleDelete, handleEdit: handleEdit, handleFlag: handleFlag, handleMute: handleMute, handlePin: handlePin, inline: true, message: message, messageListRect: messageListRect, messageWrapperRef: messageWrapperRef, setEditingState: setEditingState })))),
                    message && (React.createElement("span", { className: isOnlyEmojis(message.text) ? 'str-chat__message-team-text--is-emoji' : '', "data-testid": 'message-team-message', onClick: onMentionsClickMessage, onMouseOver: onMentionsHoverMessage }, unsafeHTML && message.html ? (React.createElement("div", { dangerouslySetInnerHTML: { __html: message.html } })) : (messageText))),
                    message.mml && React.createElement(MML, { actionHandler: handleAction, align: 'left', source: message.mml }),
                    message.text === '' && (React.createElement(MessageTeamAttachments, { Attachment: Attachment, handleAction: handleAction, message: message })),
                    ((_k = message.latest_reactions) === null || _k === void 0 ? void 0 : _k.length) !== 0 && message.text !== '' && isReactionEnabled && (React.createElement(ReactionsList, { handleReaction: handleReaction, onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
                    message.status === 'failed' && (React.createElement("button", { className: 'str-chat__message-team-failed', "data-testid": 'message-team-failed', onClick: message.errorStatusCode !== 403 ? function () { return handleRetry(message); } : undefined },
                        ...
                        message.errorStatusCode !== 403
                            ? t('Message Failed · Click to try again')
                            : t('Message Failed · Unauthorized')))),
                React.createElement(MessageTeamStatus, { Avatar: Avatar$1, isMyMessage: isMyMessage, lastReceivedId: lastReceivedId, message: message, readBy: readBy, threadList: threadList }),
                message.text !== '' && message.attachments && (React.createElement(MessageTeamAttachments, { Attachment: Attachment, handleAction: handleAction, message: message })),
                message.latest_reactions &&
                    message.latest_reactions.length !== 0 &&
                    message.text === '' &&
                    isReactionEnabled && (React.createElement(ReactionsList, { handleReaction: handleReaction, onClick: onReactionListClick, own_reactions: message.own_reactions, reaction_counts: message.reaction_counts || undefined, reactions: message.latest_reactions })),
...
var MessageTeamStatus = function (props) {
    ...
    if (message && message.status === 'sending') {
        return (React.createElement("span", { className: 'str-chat__message-team-status', "data-testid": 'message-team-sending' },
            React.createElement(Tooltip, null, t('Sending...')),
            React.createElement(LoadingIndicator, null)));
    }
    if (readBy && readBy.length !== 0 && !threadList && !justReadByMe) {
        ...
        return (React.createElement("span", { className: 'str-chat__message-team-status' },
            React.createElement(Tooltip, null, getReadByTooltipText(readBy, t, client)),
            React.createElement(Avatar$1, { image: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.image, name: lastReadUser === null || lastReadUser === void 0 ? void 0 : lastReadUser.name, size: 15 }),
            readBy.length - 1 > 1 && (React.createElement("span", { className: 'str-chat__message-team-status-number', "data-testid": 'message-team-read-by-count' }, readBy.length - 1))));
    }
    if (message && message.status === 'received' && message.id === lastReceivedId && !threadList) {
        return (React.createElement("span", { className: 'str-chat__message-team-status', "data-testid": 'message-team-received' },
            React.createElement(Tooltip, null, t('Delivered')),
            React.createElement(DeliveredCheckIcon, null)));
    }
    return null;
...
var MessageTeamAttachments = function (props) {
    ...
    if (message.attachments) {
        return React.createElement(Attachment$1, { actionHandler: handleAction, attachments: message.attachments });
    }
    return null;
};
...
var MessageTeam = function (props) {
    ...
    return (React.createElement(MemoizedMessageTeam, __assign({}, props, { channel: channel, isReactionEnabled: isReactionEnabled, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions })));
};
...
var ChannelInner = function (props) {
    var acceptedFiles = props.acceptedFiles, _a = props.Attachment, Attachment$1 = _a === void 0 ? Attachment : _a, channel = props.channel, children = props.children, doMarkReadRequest = props.doMarkReadRequest, doSendMessageRequest = props.doSendMessageRequest, doUpdateMessageRequest = props.doUpdateMessageRequest, _b = props.Emoji, Emoji = _b === void 0 ? DefaultEmoji : _b, _c = props.emojiData, emojiData = _c === void 0 ? defaultEmojiData : _c, _d = props.EmojiIndex, EmojiIndex = _d === void 0 ? DefaultEmojiIndex : _d, _e = props.EmojiPicker, EmojiPicker = _e === void 0 ? DefaultEmojiPicker : _e, _f = props.LoadingErrorIndicator, LoadingErrorIndicator$1 = _f === void 0 ? LoadingErrorIndicator : _f, _g = props.LoadingIndicator, LoadingIndicator$1 = _g === void 0 ? LoadingIndicator : _g, maxNumberOfFiles = props.maxNumberOfFiles, _h = props.Message, Message = _h === void 0 ? MessageSimple : _h, _j = props.multipleUploads, multipleUploads = _j === void 0 ? true : _j, onMentionsClick = props.onMentionsClick, onMentionsHover = props.onMentionsHover;
    ...
    var doSendMessage = useCallback(function (message) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    if (state.error) {
        return (React.createElement("div", { className: "str-chat str-chat-channel " + theme },
            React.createElement(LoadingErrorIndicator$1, { error: state.error })));
    }
    if (state.loading) {
        return (React.createElement("div", { className: "str-chat str-chat-channel " + theme },
            React.createElement(LoadingIndicator$1, { size: 25 })));
    }
    ...
    return (React.createElement("div", { className: "str-chat str-chat-channel " + theme + (useImageFlagEmojisOnWindows && navigator.platform.match(/Win/)
            ...
            : '') },
        React.createElement(ChannelProvider, { value: channelContextValue },
...
var UnMemoizedChannelHeader = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__header-livestream' },
        React.createElement("div", { className: 'str-chat__header-hamburger', onClick: openMobileNav },
            ...
            React.createElement("span", { className: 'str-chat__header-hamburger--line' }),
            React.createElement("span", { className: 'str-chat__header-hamburger--line' })),
        image && (React.createElement(Avatar$1, { image: image, shape: 'rounded', size: (channel === null || channel === void 0 ? void 0 : channel.type) === 'commerce' ? 60 : 40 })),
...
var ChannelListTeam = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__channel-list-team' },
        showSidebar && (React.createElement("div", { className: 'str-chat__channel-list-team__sidebar' },
            React.createElement("div", { className: 'str-chat__channel-list-team__sidebar--top' },
                React.createElement(Avatar$1, { image: sidebarImage, size: 50 })))),
        React.createElement("div", { className: 'str-chat__channel-list-team__main' },
            React.createElement("div", { className: 'str-chat__channel-list-team__header' },
                React.createElement("div", { className: 'str-chat__channel-list-team__header--left' },
                    React.createElement(Avatar$1, { image: image, name: name || id, size: 40 })),
                React.createElement("div", { className: 'str-chat__channel-list-team__header--middle' },
                    React.createElement("div", { className: 'str-chat__channel-list-team__header--title' }, name || id),
                    React.createElement("div", { className: "str-chat__channel-list-team__header--status " + status }, status)),
                React.createElement("div", { className: 'str-chat__channel-list-team__header--right' },
                    React.createElement("button", { className: 'str-chat__channel-list-team__header--button' },
                        React.createElement("img", { src: chevrondown })))),
            children)));
};
        ...
        var handleEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        channel_1 = _a.sent();
                        setChannels(function (channels) { return uniqBy(__spreadArrays([channel_1], channels), 'cid'); });
                        _a.label = 3;
                    case 3: return [2 /*return*/];
                }
            });
...
var UnMemoizedChannelPreviewCountOnly = function (props) {
    ...
    return (React.createElement("div", { className: unread && unread >= 1 ? 'unread' : '' },
        React.createElement("button", { onClick: function () {
                if (setActiveChannel) {
...
var UnMemoizedChannelPreviewLastMessage = function (props) {
    ...
    return (React.createElement("div", { className: "str-chat__channel-preview " + unreadClass + " " + activeClass },
        React.createElement("button", { "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
            ...
            React.createElement(Avatar$1, { image: displayImage, name: displayTitle }),
...
var UnMemoizedLoadMoreButton = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__load-more-button' },
        React.createElement("button", { className: 'str-chat__load-more-button__button', "data-testid": 'load-more-button', disabled: refreshing, onClick: onClick }, refreshing ? React.createElement(LoadingIndicator$1, null) : children)));
};
...
var UnMemoizedLoadMorePaginator = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        !reverse && children,
        hasNextPage && React.createElement(LoadMoreButton$1, { onClick: loadNextPage, refreshing: refreshing }),
        reverse && children));
};
...
var UnMemoizedChannelList = function (props) {
    ...
    var _o = useState(0), channelUpdateCount = _o[0], setChannelUpdateCount = _o[1];
    /**
    ...
    var renderList = function () { return (React.createElement(List, { Avatar: Avatar$1, error: status.error, loading: status.loadingChannels, LoadingErrorIndicator: LoadingErrorIndicator, LoadingIndicator: LoadingIndicator, showSidebar: showSidebar }, !loadedChannels || loadedChannels.length === 0 ? (React.createElement(EmptyStateIndicator$1, { listType: 'channel' })) : (React.createElement(Paginator, { hasNextPage: hasNextPage, loadNextPage: loadNextPage, refreshing: status.refreshing }, loadedChannels.map(renderChannel))))); };
    return (React.createElement(React.Fragment, null,
...
var ChannelListMessenger = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__channel-list-messenger' },
        React.createElement("div", { className: 'str-chat__channel-list-messenger__main' }, children)));
};
...
var UnMemoizedChannelPreviewCompact = function (props) {
    ...
    return (React.createElement("button", { className: "str-chat__channel-preview-compact " + unreadClass + " " + activeClass, "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
        React.createElement("div", { className: 'str-chat__channel-preview-compact--left' },
            React.createElement(Avatar$1, { image: displayImage, name: displayTitle, size: 20 })),
        React.createElement("div", { className: 'str-chat__channel-preview-compact--right' }, displayTitle)));
};
/**
 *  Used as preview component for channel item in [ChannelList](#channellist) component.
...
var UnMemoizedChannelPreviewMessenger = function (props) {
    ...
    return (React.createElement("button", { className: "str-chat__channel-preview-messenger " + unreadClass + " " + activeClass, "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
        React.createElement("div", { className: 'str-chat__channel-preview-messenger--left' }, React.createElement(Avatar$1, { image: displayImage, name: displayTitle, size: 40 })),
        React.createElement("div", { className: 'str-chat__channel-preview-messenger--right' },
            ...
            React.createElement("div", { className: 'str-chat__channel-preview-messenger--last-message' }, truncate(latestMessage, latestMessageLength)))));
};
/**
 * Used as preview component for channel item in [ChannelList](#channellist) component.
...
var UnMemoizedChannelSearch = function () { return (React.createElement("div", { className: 'str-chat__channel-search' },
    React.createElement("input", { placeholder: 'Search', type: 'text' }),
    React.createElement("button", { type: 'submit' },
        React.createElement("svg", { height: '17', viewBox: '0 0 18 17', width: '18', xmlns: 'http://www.w3.org/2000/svg' },
            React.createElement("path", { d: 'M0 17.015l17.333-8.508L0 0v6.617l12.417 1.89L0 10.397z', fillRule: 'evenodd' }))))); };
...
var useChat = function (_a) {
    ...
    var _d = useState(), channel = _d[0], setChannel = _d[1];
    var _e = useState([]), mutes = _e[0], setMutes = _e[1];
    var _f = useState(initialNavOpen), navOpen = _f[0], setNavOpen = _f[1];
...
var UnMemoizedEventComponent = function (props) {
    ...
    if (type === 'channel.event' &&
        ...
        return (React.createElement("div", { className: 'str-chat__event-component__channel-event' },
            React.createElement(Avatar$1, { image: (_c = event === null || event === void 0 ? void 0 : event.user) === null || _c === void 0 ? void 0 : _c.image, name: name_1 }),
...
var InfiniteScrollPaginator = function (props) {
    var children = props.children, hasNextPage = props.hasNextPage, _a = props.LoadingIndicator, LoadingIndicator = _a === void 0 ? LoadingIndicator$1 : _a, loadNextPage = props.loadNextPage, refreshing = props.refreshing, reverse = props.reverse, threshold = props.threshold;
...
var ReverseInfiniteScroll = function (props) { return (React.createElement(InfiniteScroll, __assign({}, props, { isReverse: true }))); };

var UnMemoizedCustomNotification = function (props) {
    var active = props.active, children = props.children, type = props.type;
    if (!active)
        return null;
    return (React.createElement("div", { className: "str-chat__custom-notification notification-" + type, "data-testid": 'custom-notification' }, children));
};
...
var UnMemoizedMessageListInner = function (props) {
        ...
        return enrichedMessages.map(function (message) {
            ...
            if (message.type === 'message.date' && message.date && isDate(message.date)) {
                return (React.createElement("li", { key: message.date.toISOString() + "-i" },
                    React.createElement(DateSeparator, { date: message.date, unread: message.unread })));
            }
            ...
            if (message.type !== 'message.read') {
                ...
                return (React.createElement("li", { className: "str-chat__li str-chat__li--" + groupStyles, key: message.id || message.created_at, onLoadCapture: onMessageLoadCaptured },
                    React.createElement(Message, __assign({ client: client, groupStyles: [groupStyles], lastReceivedId: lastReceivedId, message: message, readBy: readData[message.id] || [], threadList: threadList }, internalMessageProps))));
            }
            return null;
        });
    }, [
    ...
    if (!elements.length && EmptyStateIndicator) {
        return React.createElement(EmptyStateIndicator, { listType: 'message' });
    }
    return (React.createElement(InfiniteScroll, __assign({ className: 'str-chat__reverse-infinite-scroll', "data-testid": 'reverse-infinite-scroll', isReverse: true, useWindow: false }, internalInfiniteScrollProps),
...
var UnMemoizedMessageNotification = function (props) {
    ...
    if (!showNotification)
        return null;
    return (React.createElement("button", { className: 'str-chat__message-notification', "data-testid": 'message-notification', onClick: onClick }, children));
};
...
var UnMemoizedTypingIndicator = function (props) {
    ...
    return (React.createElement("div", { className: "str-chat__typing-indicator " + ((threadList && typingInThread) || (!threadList && typingInChannel.length)
            ? 'str-chat__typing-indicator--typing'
            : '') },
        React.createElement("div", { className: 'str-chat__typing-indicator__avatars' }, typingInChannel.map(function (_a, i) {
            var user = _a.user;
            return (React.createElement(Avatar$1, { image: user === null || user === void 0 ? void 0 : user.image, key: (user === null || user === void 0 ? void 0 : user.id) + "-" + i, name: (user === null || user === void 0 ? void 0 : user.name) || (user === null || user === void 0 ? void 0 : user.id), size: avatarSize }));
        })),
...
var MessageListWithContext = /** @class */ (function (_super) {
    ...
    MessageListWithContext.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "str-chat__list " + (this.props.threadList ? 'str-chat__list--thread' : ''), ref: this.messageList },
                React.createElement(MessageListInner, { bottomRef: this.bottomRef, channel: this.props.channel, client: this.props.client, DateSeparator: DateSeparator$1, disableDateSeparator: this.props.disableDateSeparator, EmptyStateIndicator: EmptyStateIndicator$1, HeaderComponent: this.props.HeaderComponent, headerPosition: this.props.headerPosition, hideDeletedMessages: this.props.hideDeletedMessages, hideNewMessageSeparator: this.props.hideNewMessageSeparator, internalInfiniteScrollProps: __assign({ hasMore: this.props.hasMore, isLoading: this.props.loadingMore, listenToScroll: this.listenToScroll, loader: (React.createElement(Center, { key: 'loadingindicator' },
                            React.createElement(LoadingIndicator$1, { size: 20 }))), loadMore: this.loadMore }, internalInfiniteScrollProps), internalMessageProps: {
            ...
            React.createElement("div", { className: 'str-chat__list-notifications' },
                ...
                React.createElement(MessageNotification, { onClick: this.goToNewMessages, showNotification: this.state.newMessagesNotification }, t('New Messages!')))));
    };
...
var MessageList = function (props) {
    ...
    return React.createElement(MessageListWithContext, __assign({ client: client }, channelContext, translation, props));
};
...
var VirtualizedMessageListWithContext = function (props) {
    ...
    var messageRenderer = useCallback(function (messageList, virtuosoIndex) {
        ...
        if (message.type === 'message.date' && message.date && isDate(message.date)) {
            return React.createElement(DateSeparator$1, { date: message.date, unread: message.unread });
        }
        if (!message)
        ...
        return (React.createElement(Message, { groupedByUser: shouldGroupByUser &&
    ...
    var virtuosoComponents = useMemo(function () {
        var EmptyPlaceholder = function () { return (React.createElement(React.Fragment, null, EmptyStateIndicator$1 && React.createElement(EmptyStateIndicator$1, { listType: 'message' }))); };
        var Header = function () {
            return loadingMore ? (React.createElement("div", { className: 'str-chat__virtual-list__loading' },
                React.createElement(LoadingIndicator$1, { size: 20 }))) : (React.createElement(React.Fragment, null));
        };
    ...
    return (React.createElement("div", { className: 'str-chat__virtual-list' },
        ...
        React.createElement("div", { className: 'str-chat__list-notifications' },
            React.createElement(MessageNotification, { onClick: function () {
                    if (virtuoso.current) {
...
function VirtualizedMessageList(props) {
    ...
    return (React.createElement(VirtualizedMessageListWithContext, __assign({ channel: context.channel, client: context.client, hasMore: !!context.hasMore, loadingMore: !!context.loadingMore, 
        // @ts-expect-error
...
var DefaultThreadHeader = function (props) {
    ...
    return (React.createElement("div", { className: 'str-chat__thread-header' },
        React.createElement("div", { className: 'str-chat__thread-header-details' },
            React.createElement("strong", null, t && t('Thread')),
            React.createElement("small", null, getReplyCount())),
        React.createElement("button", { className: 'str-chat__square-button', "data-testid": 'close-button', onClick: function (event) { return closeThread && closeThread(event); } },
            React.createElement("svg", { height: '10', width: '10', xmlns: 'http://www.w3.org/2000/svg' },
                React.createElement("path", { d: 'M9.916 1.027L8.973.084 5 4.058 1.027.084l-.943.943L4.058 5 .084 8.973l.943.943L5 5.942l3.973 3.974.943-.943L5.942 5z', fillRule: 'evenodd' })))));
};
var ThreadInner = function (props) {
    ...
    return (React.createElement("div", { className: "str-chat__thread " + (fullWidth ? 'str-chat__thread--full' : '') },
        React.createElement(ThreadHeader, { closeThread: closeThread, t: t, thread: thread }),
        React.createElement("div", { className: 'str-chat__thread-list', ref: messageList },
            React.createElement(Message, __assign({ channel: channel, client: client, initialMessage: true, message: thread, Message: ThreadMessage, threadList: true }, additionalParentMessageProps)),
            React.createElement("div", { className: 'str-chat__thread-start' }, t('Start of a new thread')),
            React.createElement(MessageList, __assign({ hasMore: threadHasMore, loadingMore: threadLoadingMore, loadMore: loadMoreThread, Message: ThreadMessage, messages: threadMessages || [], read: read, threadList: true }, additionalMessageListProps))),
        React.createElement(ThreadMessageInput, __assign({ focus: autoFocus, Input: MessageInputSmall, parent: thread, publishTypingEvent: false }, additionalMessageInputProps))));
};
...
var UnMemoizedWindow = function (props) {
    ...
    if (thread && hideOnThread)
        return null;
    return React.createElement("div", { className: "str-chat__main-panel" }, children);
};
/**
