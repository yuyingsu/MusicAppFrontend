...
export interface GroupedVirtuosoProps<D> extends Omit<VirtuosoProps<D>, 'totalCount' | 'itemContent'>, Pick<ListProps, 'groupCounts' | 'groupContent'> {
    /**
...
export declare const Virtuoso: <D extends unknown = any>(props: VirtuosoProps<D> & {
    ref?: ((instance: VirtuosoHandle | null) => void) | React.RefObject<VirtuosoHandle> | null | undefined;
}) => ReactElement;
export declare const GroupedVirtuoso: <D extends unknown = any>(props: GroupedVirtuosoProps<D> & {
    ref?: ((instance: GroupedVirtuosoHandle | null) => void) | React.RefObject<GroupedVirtuosoHandle> | null | undefined;
}) => ReactElement;
export declare const VirtuosoGrid: ForwardRefExoticComponent<VirtuosoGridProps>;
export {};
