 ...
 */
var AttachmentIcon = function () { return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "20", viewBox: "0 0 24 24" },
    React.createElement("path", { d: "M16.5 6v11.5c0 2.21-1.79 4-4 4s-4-1.79-4-4V5a2.5 2.5 0 0 1 5 0v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5a2.5 2.5 0 0 0 5 0V5c0-2.21-1.79-4-4-4S7 2.79 7 5v12.5c0 3.04 2.46 5.5 5.5 5.5s5.5-2.46 5.5-5.5V6h-1.5z" }),
...
var FileIcon = function (_a) {
    ...
    if (big) {
        ...
        return React.createElement(BigFileIcon, __assign({ extension: extension.full }, style, { size: size }));
    }
    return (React.createElement(FontAwesomeIcon, { className: "rfu-file-icon--small", icon: mimeTypeToIcon(mimeType) }));
};
...
var FileUploadButton = function (_a) {
    var _b = _a.disabled, disabled = _b === void 0 ? false : _b, _c = _a.multiple, multiple = _c === void 0 ? false : _c, _d = _a.children, children = _d === void 0 ? React.createElement(AttachmentIcon, null) : _d, handleFiles = _a.handleFiles, accepts = _a.accepts;
    ...
    return (React.createElement("div", { className: className },
        React.createElement("label", null,
            React.createElement("input", { type: "file", ref: inputRef, className: "rfu-file-input", onChange: function (event) {
...
var IconButton = function (_a) {
    ...
    return (React.createElement("div", { className: "rfu-icon-button", role: "button", onClick: onClick }, children));
};
...
var Thumbnail = function (props) {
    ...
    return (React.createElement("div", { className: "rfu-thumbnail__wrapper", style: { width: size, height: size } },
        ...
        React.createElement("img", { src: imgSrc || image || placeholder, className: "rfu-thumbnail__image", alt: "" })));
};

/**
 * An icon of a picture, which is used as the default icon for ImageUploadButton
 */
var PictureIcon = function () { return (React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("path", { d: "M2 0h16a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm3 2a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM2 16v2h16v-6l-3-3-6 6-3-3-4 4z", fillRule: "nonzero" }))); };

var ImageUploadButton = function (props) {
    var _a = props.multiple, multiple = _a === void 0 ? false : _a, _b = props.disabled, disabled = _b === void 0 ? false : _b, handleFiles = props.handleFiles, _c = props.children, children = _c === void 0 ? React.createElement(PictureIcon, null) : _c;
    return (React.createElement("div", { className: "rfu-image-upload-button" },
        React.createElement("label", null,
            React.createElement("input", { type: "file", className: "rfu-image-input", onChange: function (event) {
                    var files = event.currentTarget.files;
                    if (files) {
...
var ThumbnailPlaceholder = function (props) {
    ...
    return (React.createElement(ImageUploadButton, { handleFiles: handleFiles, multiple: multiple },
        React.createElement("div", { role: "button", className: "rfu-thumbnail-placeholder" },
            React.createElement("svg", { width: "14", height: "15", viewBox: "0 0 14 15", xmlns: "http://www.w3.org/2000/svg" },
                React.createElement("path", { d: "M14 8.998H8v6H6v-6H0v-2h6v-6h2v6h6z", fill: "#A0B2B8", fillRule: "nonzero" })))));
};
...
export { AttachmentIcon, FileIcon, FilePreviewer, FileUploadButton, IconButton, ImageDropzone, ImagePreviewer, ImageUploadButton, LoadingIndicator, PictureIcon, Thumbnail, ThumbnailPlaceholder, dataTransferItemsHaveFiles, dataTransferItemsToFiles };
